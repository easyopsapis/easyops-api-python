...
import sys
from ens_sdk.model.container.container_pb2 import (
    ContainerConfig as ens_sdk___model___container___container_pb2___ContainerConfig,
)

from ens_sdk.model.container.deployment_status_pb2 import (
    DeploymentStatus as ens_sdk___model___container___deployment_status_pb2___DeploymentStatus,
)

from ens_sdk.model.container.deployment_strategy_pb2 import (
    DeploymentStrategy as ens_sdk___model___container___deployment_strategy_pb2___DeploymentStrategy,
)

from ens_sdk.model.container.local_object_reference_pb2 import (
    LocalObjectReference as ens_sdk___model___container___local_object_reference_pb2___LocalObjectReference,
)

from ens_sdk.model.container.volume_pb2 import (
    Volume as ens_sdk___model___container___volume_pb2___Volume,
)
...
class Workload(google___protobuf___message___Message):
    ...
    @property
    def containers(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[ens_sdk___model___container___container_pb2___ContainerConfig]: ...

    @property
    def volumes(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[ens_sdk___model___container___volume_pb2___Volume]: ...
    ...
    @property
    def deploymentStrategy(self) -> ens_sdk___model___container___deployment_strategy_pb2___DeploymentStrategy: ...

    @property
    def imagePullSecrets(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[ens_sdk___model___container___local_object_reference_pb2___LocalObjectReference]: ...

    @property
    def deploymentStatus(self) -> ens_sdk___model___container___deployment_status_pb2___DeploymentStatus: ...
    ...
    def __init__(self,
        *,
        ...
        containers : typing___Optional[typing___Iterable[ens_sdk___model___container___container_pb2___ContainerConfig]] = None,
        replicas : typing___Optional[builtin___int] = None,
        volumes : typing___Optional[typing___Iterable[ens_sdk___model___container___volume_pb2___Volume]] = None,
        ...
        deploymentStrategy : typing___Optional[ens_sdk___model___container___deployment_strategy_pb2___DeploymentStrategy] = None,
        imagePullSecrets : typing___Optional[typing___Iterable[ens_sdk___model___container___local_object_reference_pb2___LocalObjectReference]] = None,
        deploymentStatus : typing___Optional[ens_sdk___model___container___deployment_status_pb2___DeploymentStatus] = None,
