...
from idcmanager_sdk.model.container.ingress_backend_pb2 import (
    IngressBackend as idcmanager_sdk___model___container___ingress_backend_pb2___IngressBackend,
)

from idcmanager_sdk.model.container.ingress_rule_pb2 import (
    IngressRule as idcmanager_sdk___model___container___ingress_rule_pb2___IngressRule,
)

from idcmanager_sdk.model.container.ingress_tls_pb2 import (
    IngressTLS as idcmanager_sdk___model___container___ingress_tls_pb2___IngressTLS,
)
...
class Ingress(google___protobuf___message___Message):
    ...
    @property
    def backend(self) -> idcmanager_sdk___model___container___ingress_backend_pb2___IngressBackend: ...

    @property
    def rules(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[idcmanager_sdk___model___container___ingress_rule_pb2___IngressRule]: ...

    @property
    def tls(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[idcmanager_sdk___model___container___ingress_tls_pb2___IngressTLS]: ...
    ...
    def __init__(self,
        *,
        ...
        backend : typing___Optional[idcmanager_sdk___model___container___ingress_backend_pb2___IngressBackend] = None,
        rules : typing___Optional[typing___Iterable[idcmanager_sdk___model___container___ingress_rule_pb2___IngressRule]] = None,
        tls : typing___Optional[typing___Iterable[idcmanager_sdk___model___container___ingress_tls_pb2___IngressTLS]] = None,
