...
from metadata_center_sdk.model.container.loadbalancer_status_pb2 import (
    LoadBalancerStatus as metadata_center_sdk___model___container___loadbalancer_status_pb2___LoadBalancerStatus,
)

from metadata_center_sdk.model.container.service_spec_pb2 import (
    ServiceSpec as metadata_center_sdk___model___container___service_spec_pb2___ServiceSpec,
)
...
class Service(google___protobuf___message___Message):
    ...
    class Status(google___protobuf___message___Message):
        ...
        @property
        def loadBalancer(self) -> metadata_center_sdk___model___container___loadbalancer_status_pb2___LoadBalancerStatus: ...

        def __init__(self,
            *,
            loadBalancer : typing___Optional[metadata_center_sdk___model___container___loadbalancer_status_pb2___LoadBalancerStatus] = None,
            ) -> None: ...
        if sys.version_info >= (3,):
            @classmethod
    ...
    @property
    def spec(self) -> metadata_center_sdk___model___container___service_spec_pb2___ServiceSpec: ...
    ...
    def __init__(self,
        *,
        ...
        spec : typing___Optional[metadata_center_sdk___model___container___service_spec_pb2___ServiceSpec] = None,
