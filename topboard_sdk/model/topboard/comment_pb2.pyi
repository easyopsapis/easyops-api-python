...
class Comment(google___protobuf___message___Message):
    ...
    @property
    def author(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[topboard_sdk___model___cmdb___user_pb2___User]: ...
    ...
    def __init__(self,
        *,
        ...
        author : typing___Optional[typing___Iterable[topboard_sdk___model___cmdb___user_pb2___User]] = None,
        ) -> None: ...
    if sys.version_info >= (3,):
        @classmethod
