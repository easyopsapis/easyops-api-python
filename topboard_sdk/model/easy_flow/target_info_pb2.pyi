...
from topboard_sdk.model.easy_flow.version_info_pb2 import (
    VersionInfo as topboard_sdk___model___easy_flow___version_info_pb2___VersionInfo,
)
...
class TargetInfo(google___protobuf___message___Message):
    ...
    class InstanceInfo(google___protobuf___message___Message):
        ...
        @property
        def versionInfo(self) -> topboard_sdk___model___easy_flow___version_info_pb2___VersionInfo: ...

        def __init__(self,
            *,
            versionName : typing___Optional[typing___Text] = None,
            versionInfo : typing___Optional[topboard_sdk___model___easy_flow___version_info_pb2___VersionInfo] = None,
    ...
    class OperationInfo(google___protobuf___message___Message):
        ...
        @property
        def versionToInfo(self) -> topboard_sdk___model___easy_flow___version_info_pb2___VersionInfo: ...

        @property
        def versionFromInfo(self) -> topboard_sdk___model___easy_flow___version_info_pb2___VersionInfo: ...

        def __init__(self,
            *,
            operation : typing___Optional[typing___Text] = None,
            versionToInfo : typing___Optional[topboard_sdk___model___easy_flow___version_info_pb2___VersionInfo] = None,
            versionFromInfo : typing___Optional[topboard_sdk___model___easy_flow___version_info_pb2___VersionInfo] = None,
            installPath : typing___Optional[typing___Text] = None,
            packageId : typing___Optional[typing___Text] = None,
            ) -> None: ...
        if sys.version_info >= (3,):
