...
from flowable_sdk.model.container import container_port_pb2 as flowable__sdk_dot_model_dot_container_dot_container__port__pb2
from flowable_sdk.model.container import volume_mount_pb2 as flowable__sdk_dot_model_dot_container_dot_volume__mount__pb2
from flowable_sdk.model.container import env_var_pb2 as flowable__sdk_dot_model_dot_container_dot_env__var__pb2
from flowable_sdk.model.container import resource_requirements_pb2 as flowable__sdk_dot_model_dot_container_dot_resource__requirements__pb2
from flowable_sdk.model.container import probe_pb2 as flowable__sdk_dot_model_dot_container_dot_probe__pb2
...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  serialized_pb=_b('\n\x0f\x63ontainer.proto\x12\tcontainer\x1a\x31\x66lowable_sdk/model/container/container_port.proto\x1a/flowable_sdk/model/container/volume_mount.proto\x1a*flowable_sdk/model/container/env_var.proto\x1a\x38\x66lowable_sdk/model/container/resource_requirements.proto\x1a(flowable_sdk/model/container/probe.proto\"\x91\x03\n\x0f\x43ontainerConfig\x12\x0c\n\x04name\x18\x01 \x01(\t\x12\r\n\x05image\x18\x02 \x01(\t\x12\x12\n\nworkingDir\x18\x03 \x01(\t\x12\x17\n\x0fimagePullPolicy\x18\x04 \x01(\t\x12\x0f\n\x07\x63ommand\x18\x05 \x03(\t\x12\x0c\n\x04\x61rgs\x18\x06 \x03(\t\x12\'\n\x05ports\x18\x07 \x03(\x0b\x32\x18.container.ContainerPort\x12,\n\x0cvolumeMounts\x18\x08 \x03(\x0b\x32\x16.container.VolumeMount\x12\x1e\n\x03\x65nv\x18\t \x03(\x0b\x32\x11.container.EnvVar\x12\x32\n\tresources\x18\n \x01(\x0b\x32\x1f.container.ResourceRequirements\x12(\n\x0ereadinessProbe\x18\x0b \x01(\x0b\x32\x10.container.Probe\x12\'\n\rlivenessProbe\x18\x0c \x01(\x0b\x32\x10.container.Probe\x12\x17\n\x0f\x61rtifactVersion\x18\r \x01(\tBEZCgo.easyops.local/contracts/protorepo-models/easyops/model/containerb\x06proto3')
  ,
  dependencies=[flowable__sdk_dot_model_dot_container_dot_container__port__pb2.DESCRIPTOR,flowable__sdk_dot_model_dot_container_dot_volume__mount__pb2.DESCRIPTOR,flowable__sdk_dot_model_dot_container_dot_env__var__pb2.DESCRIPTOR,flowable__sdk_dot_model_dot_container_dot_resource__requirements__pb2.DESCRIPTOR,flowable__sdk_dot_model_dot_container_dot_probe__pb2.DESCRIPTOR,])
...
_CONTAINERCONFIG.fields_by_name['ports'].message_type = flowable__sdk_dot_model_dot_container_dot_container__port__pb2._CONTAINERPORT
_CONTAINERCONFIG.fields_by_name['volumeMounts'].message_type = flowable__sdk_dot_model_dot_container_dot_volume__mount__pb2._VOLUMEMOUNT
_CONTAINERCONFIG.fields_by_name['env'].message_type = flowable__sdk_dot_model_dot_container_dot_env__var__pb2._ENVVAR
_CONTAINERCONFIG.fields_by_name['resources'].message_type = flowable__sdk_dot_model_dot_container_dot_resource__requirements__pb2._RESOURCEREQUIREMENTS
_CONTAINERCONFIG.fields_by_name['readinessProbe'].message_type = flowable__sdk_dot_model_dot_container_dot_probe__pb2._PROBE
_CONTAINERCONFIG.fields_by_name['livenessProbe'].message_type = flowable__sdk_dot_model_dot_container_dot_probe__pb2._PROBE
