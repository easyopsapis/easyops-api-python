...
from flowable_sdk.model.easy_flow.deploy_package_result_pb2 import (
    DeployPackageResult as flowable_sdk___model___easy_flow___deploy_package_result_pb2___DeployPackageResult,
)
...
class TargetResult(google___protobuf___message___Message):
    ...
    @property
    def packageStatus(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[flowable_sdk___model___easy_flow___deploy_package_result_pb2___DeployPackageResult]: ...
    ...
    def __init__(self,
        *,
        ...
        packageStatus : typing___Optional[typing___Iterable[flowable_sdk___model___easy_flow___deploy_package_result_pb2___DeployPackageResult]] = None,
        ) -> None: ...
    if sys.version_info >= (3,):
        @classmethod
