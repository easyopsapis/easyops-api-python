...
import sys
from cmdb_extend_sdk.model.console.cmdb_query_strategy_pb2 import (
    CmdbQueryStrategy as cmdb_extend_sdk___model___console___cmdb_query_strategy_pb2___CmdbQueryStrategy,
)

from cmdb_extend_sdk.model.resource_manage.filter_condition_group_pb2 import (
    FilterConditionGroup as cmdb_extend_sdk___model___resource_manage___filter_condition_group_pb2___FilterConditionGroup,
)
...
class FilterStrategy(google___protobuf___message___Message):
    ...
    @property
    def query(self) -> cmdb_extend_sdk___model___console___cmdb_query_strategy_pb2___CmdbQueryStrategy: ...

    @property
    def filter(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[cmdb_extend_sdk___model___resource_manage___filter_condition_group_pb2___FilterConditionGroup]: ...
    ...
    def __init__(self,
        *,
        ...
        query : typing___Optional[cmdb_extend_sdk___model___console___cmdb_query_strategy_pb2___CmdbQueryStrategy] = None,
        filter : typing___Optional[typing___Iterable[cmdb_extend_sdk___model___resource_manage___filter_condition_group_pb2___FilterConditionGroup]] = None,
