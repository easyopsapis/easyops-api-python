...
import sys
from cmdb_extend_sdk.model.easy_command.action_pb2 import (
    Action as cmdb_extend_sdk___model___easy_command___action_pb2___Action,
)

from cmdb_extend_sdk.model.easy_command.target_pb2 import (
    Target as cmdb_extend_sdk___model___easy_command___target_pb2___Target,
)

from cmdb_extend_sdk.model.easy_command.task_callback_pb2 import (
    TaskCallback as cmdb_extend_sdk___model___easy_command___task_callback_pb2___TaskCallback,
)
...
class TaskSpec(google___protobuf___message___Message):
    ...
    @property
    def actions(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[cmdb_extend_sdk___model___easy_command___action_pb2___Action]: ...

    @property
    def targets(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[cmdb_extend_sdk___model___easy_command___target_pb2___Target]: ...

    @property
    def callback(self) -> cmdb_extend_sdk___model___easy_command___task_callback_pb2___TaskCallback: ...
    ...
    def __init__(self,
        *,
        ...
        actions : typing___Optional[typing___Iterable[cmdb_extend_sdk___model___easy_command___action_pb2___Action]] = None,
        targets : typing___Optional[typing___Iterable[cmdb_extend_sdk___model___easy_command___target_pb2___Target]] = None,
        ...
        callback : typing___Optional[cmdb_extend_sdk___model___easy_command___task_callback_pb2___TaskCallback] = None,
