...
class BindPipelineRequest(google___protobuf___message___Message):
    ...
    @property
    def pipeline(self) -> model___cmdb_extend___app_pipeline_pb2___AppPipeline: ...

    def __init__(self,
        appId : typing___Optional[typing___Text] = None,
        pipeline : typing___Optional[model___cmdb_extend___app_pipeline_pb2___AppPipeline] = None,
        ) -> None: ...
    @classmethod
    def FromString(cls, s: bytes) -> BindPipelineRequest: ...
    def MergeFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    if sys.version_info >= (3,):
        def HasField(self, field_name: typing_extensions___Literal[u"pipeline"]) -> bool: ...
        def ClearField(self, field_name: typing_extensions___Literal[u"appId",u"pipeline"]) -> None: ...
    else:
        def HasField(self, field_name: typing_extensions___Literal[u"pipeline",b"pipeline"]) -> bool: ...
        def ClearField(self, field_name: typing_extensions___Literal[b"appId",b"pipeline"]) -> None: ...
...
class BindPipelineResponseWrapper(google___protobuf___message___Message):
    ...
    @classmethod
    def FromString(cls, s: bytes) -> BindPipelineResponseWrapper: ...
    def MergeFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    if sys.version_info >= (3,):
