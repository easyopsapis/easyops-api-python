...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='org_register.proto',
  package='org',
  syntax='proto3',
  serialized_options=None,
  serialized_pb=_b('\n\x12org_register.proto\x12\x03org\x1a\x1bgoogle/protobuf/empty.proto\"y\n\x18ListenOrgRegisterRequest\x12\x34\n\x06params\x18\x01 \x01(\x0b\x32$.org.ListenOrgRegisterRequest.Params\x1a\'\n\x06Params\x12\x0e\n\x06system\x18\x01 \x01(\t\x12\r\n\x05topic\x18\x02 \x01(\t\"z\n ListenOrgRegisterResponseWrapper\x12\x0c\n\x04\x63ode\x18\x01 \x01(\x05\x12\x13\n\x0b\x63odeExplain\x18\x02 \x01(\t\x12\r\n\x05\x65rror\x18\x03 \x01(\t\x12$\n\x04\x64\x61ta\x18\x04 \x01(\x0b\x32\x16.google.protobuf.Emptyb\x06proto3')
  ,
...
_LISTENORGREGISTERREQUEST_PARAMS = _descriptor.Descriptor(
  name='Params',
  full_name='org.ListenOrgRegisterRequest.Params',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='system', full_name='org.ListenOrgRegisterRequest.Params.system', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='topic', full_name='org.ListenOrgRegisterRequest.Params.topic', index=1,
...
_LISTENORGREGISTERREQUEST = _descriptor.Descriptor(
  ...
  full_name='org.ListenOrgRegisterRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='params', full_name='org.ListenOrgRegisterRequest.params', index=0,
...
_LISTENORGREGISTERRESPONSEWRAPPER = _descriptor.Descriptor(
  ...
  full_name='org.ListenOrgRegisterResponseWrapper',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='code', full_name='org.ListenOrgRegisterResponseWrapper.code', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='codeExplain', full_name='org.ListenOrgRegisterResponseWrapper.codeExplain', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='error', full_name='org.ListenOrgRegisterResponseWrapper.error', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='data', full_name='org.ListenOrgRegisterResponseWrapper.data', index=3,
...
ListenOrgRegisterRequest = _reflection.GeneratedProtocolMessageType('ListenOrgRegisterRequest', (_message.Message,), {
  ...
  'Params' : _reflection.GeneratedProtocolMessageType('Params', (_message.Message,), {
    ...
    '__module__' : 'org_register_pb2'
    # @@protoc_insertion_point(class_scope:org.ListenOrgRegisterRequest.Params)
    })
  ,
  'DESCRIPTOR' : _LISTENORGREGISTERREQUEST,
  '__module__' : 'org_register_pb2'
  # @@protoc_insertion_point(class_scope:org.ListenOrgRegisterRequest)
  })
...
ListenOrgRegisterResponseWrapper = _reflection.GeneratedProtocolMessageType('ListenOrgRegisterResponseWrapper', (_message.Message,), {
  ...
  '__module__' : 'org_register_pb2'
  # @@protoc_insertion_point(class_scope:org.ListenOrgRegisterResponseWrapper)
  })
