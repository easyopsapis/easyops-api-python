...
import sys
from flowable_service_sdk.model.console.cmdb_query_strategy_pb2 import (
    CmdbQueryStrategy as flowable_service_sdk___model___console___cmdb_query_strategy_pb2___CmdbQueryStrategy,
)

from flowable_service_sdk.model.resource_manage.filter_condition_group_pb2 import (
    FilterConditionGroup as flowable_service_sdk___model___resource_manage___filter_condition_group_pb2___FilterConditionGroup,
)
...
class FilterStrategy(google___protobuf___message___Message):
    ...
    @property
    def query(self) -> flowable_service_sdk___model___console___cmdb_query_strategy_pb2___CmdbQueryStrategy: ...

    @property
    def filter(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[flowable_service_sdk___model___resource_manage___filter_condition_group_pb2___FilterConditionGroup]: ...
    ...
    def __init__(self,
        *,
        ...
        query : typing___Optional[flowable_service_sdk___model___console___cmdb_query_strategy_pb2___CmdbQueryStrategy] = None,
        filter : typing___Optional[typing___Iterable[flowable_service_sdk___model___resource_manage___filter_condition_group_pb2___FilterConditionGroup]] = None,
