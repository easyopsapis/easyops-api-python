...
_BPMNPROCESS.fields_by_name['sequenceFlow'].message_type = flowable__service__sdk_dot_model_dot_flowable__service_dot_bpmn__sequence__flow__pb2._BPMNSEQUENCEFLOW
_BPMNPROCESS.fields_by_name['exclusiveGateway'].message_type = flowable__service__sdk_dot_model_dot_flowable__service_dot_bpmn__exclusive__gateway__pb2._BPMNEXCLUSIVEGATEWAY
_BPMNPROCESS.fields_by_name['startEvent'].message_type = flowable__service__sdk_dot_model_dot_flowable__service_dot_bpmn__start__event__pb2._BPMNSTARTEVENT
_BPMNPROCESS.fields_by_name['endEvent'].message_type = flowable__service__sdk_dot_model_dot_flowable__service_dot_bpmn__end__event__pb2._BPMNENDEVENT
_BPMNPROCESS.fields_by_name['userTask'].message_type = flowable__service__sdk_dot_model_dot_flowable__service_dot_bpmn__user__task__pb2._BPMNUSERTASK
