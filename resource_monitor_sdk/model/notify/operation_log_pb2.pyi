...
from resource_monitor_sdk.model.notify.app_pb2 import (
    App as resource_monitor_sdk___model___notify___app_pb2___App,
)

from resource_monitor_sdk.model.notify.deploy_info_pb2 import (
    DeployInfo as resource_monitor_sdk___model___notify___deploy_info_pb2___DeployInfo,
)

from resource_monitor_sdk.model.notify.device_pb2 import (
    Device as resource_monitor_sdk___model___notify___device_pb2___Device,
)
...
class OperationLog(google___protobuf___message___Message):
    ...
    @property
    def device_list(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[resource_monitor_sdk___model___notify___device_pb2___Device]: ...

    @property
    def app_list(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[resource_monitor_sdk___model___notify___app_pb2___App]: ...

    @property
    def ext_info(self) -> google___protobuf___struct_pb2___Struct: ...

    @property
    def deploy_info(self) -> resource_monitor_sdk___model___notify___deploy_info_pb2___DeployInfo: ...
    ...
    def __init__(self,
        *,
        ...
        device_list : typing___Optional[typing___Iterable[resource_monitor_sdk___model___notify___device_pb2___Device]] = None,
        ...
        app_list : typing___Optional[typing___Iterable[resource_monitor_sdk___model___notify___app_pb2___App]] = None,
        ...
        deploy_info : typing___Optional[resource_monitor_sdk___model___notify___deploy_info_pb2___DeployInfo] = None,
