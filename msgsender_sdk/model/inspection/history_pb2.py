...
_INSPECTIONHISTORY = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='targets', full_name='inspection.InspectionHistory.targets', index=8,
...
_INSPECTIONHISTORY.fields_by_name['targets'].message_type = model_dot_inspection_dot_target__pb2._INSPECTIONTARGET
DESCRIPTOR.message_types_by_name['InspectionHistory'] = _INSPECTIONHISTORY
_sym_db.RegisterFileDescriptor(DESCRIPTOR)

InspectionHistory = _reflection.GeneratedProtocolMessageType('InspectionHistory', (_message.Message,), dict(
