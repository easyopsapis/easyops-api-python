...
_TASKDETAIL.fields_by_name['callback'].message_type = model_dot_easy__command_dot_task__callback__pb2._TASKCALLBACK
_TASKDETAIL.fields_by_name['targetsLog'].message_type = model_dot_easy__command_dot_target__log__pb2._TARGETLOG
DESCRIPTOR.message_types_by_name['TaskDetail'] = _TASKDETAIL
_sym_db.RegisterFileDescriptor(DESCRIPTOR)

TaskDetail = _reflection.GeneratedProtocolMessageType('TaskDetail', (_message.Message,), dict(
