...
from msgsender_sdk.model.console.cmdb_query_strategy_pb2 import (
    CmdbQueryStrategy as msgsender_sdk___model___console___cmdb_query_strategy_pb2___CmdbQueryStrategy,
)

from msgsender_sdk.model.resource_manage.filter_condition_group_pb2 import (
    FilterConditionGroup as msgsender_sdk___model___resource_manage___filter_condition_group_pb2___FilterConditionGroup,
)
...
class FilterStrategy(google___protobuf___message___Message):
    ...
    @property
    def query(self) -> msgsender_sdk___model___console___cmdb_query_strategy_pb2___CmdbQueryStrategy: ...

    @property
    def filter(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[msgsender_sdk___model___resource_manage___filter_condition_group_pb2___FilterConditionGroup]: ...
    ...
    def __init__(self,
        *,
        ...
        query : typing___Optional[msgsender_sdk___model___console___cmdb_query_strategy_pb2___CmdbQueryStrategy] = None,
        filter : typing___Optional[typing___Iterable[msgsender_sdk___model___resource_manage___filter_condition_group_pb2___FilterConditionGroup]] = None,
