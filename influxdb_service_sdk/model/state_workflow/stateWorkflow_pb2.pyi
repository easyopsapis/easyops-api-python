...
from influxdb_service_sdk.model.state_workflow.state_pb2 import (
    State as influxdb_service_sdk___model___state_workflow___state_pb2___State,
)

from influxdb_service_sdk.model.state_workflow.transition_pb2 import (
    Transition as influxdb_service_sdk___model___state_workflow___transition_pb2___Transition,
)
...
class StateWorkflow(google___protobuf___message___Message):
    ...
    @property
    def states(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[influxdb_service_sdk___model___state_workflow___state_pb2___State]: ...
    ...
    @property
    def transitions(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[influxdb_service_sdk___model___state_workflow___transition_pb2___Transition]: ...
    ...
    def __init__(self,
        *,
        ...
        states : typing___Optional[typing___Iterable[influxdb_service_sdk___model___state_workflow___state_pb2___State]] = None,
        stateTriggers : typing___Optional[typing___Iterable[StateWorkflow.StateTriggers]] = None,
        transitions : typing___Optional[typing___Iterable[influxdb_service_sdk___model___state_workflow___transition_pb2___Transition]] = None,
