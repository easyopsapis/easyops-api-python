...
from influxdb_service_sdk.model.container.metric_target_pb2 import (
    MetricTarget as influxdb_service_sdk___model___container___metric_target_pb2___MetricTarget,
)
...
class ResourceMetricSource(google___protobuf___message___Message):
    ...
    @property
    def target(self) -> influxdb_service_sdk___model___container___metric_target_pb2___MetricTarget: ...

    def __init__(self,
        *,
        name : typing___Optional[typing___Text] = None,
        target : typing___Optional[influxdb_service_sdk___model___container___metric_target_pb2___MetricTarget] = None,
        ) -> None: ...
    if sys.version_info >= (3,):
        @classmethod
