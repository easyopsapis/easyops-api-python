...
from influxdb_service_sdk.model.monitor.alert_conditions_pb2 import (
    AlertConditions as influxdb_service_sdk___model___monitor___alert_conditions_pb2___AlertConditions,
)

from influxdb_service_sdk.model.monitor.alert_dims_pb2 import (
    AlertDims as influxdb_service_sdk___model___monitor___alert_dims_pb2___AlertDims,
)
...
class AlertRule(google___protobuf___message___Message):
    ...
    @property
    def alert_dims(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[influxdb_service_sdk___model___monitor___alert_dims_pb2___AlertDims]: ...

    @property
    def alert_conditions(self) -> influxdb_service_sdk___model___monitor___alert_conditions_pb2___AlertConditions: ...
    ...
    def __init__(self,
        *,
        ...
        alert_dims : typing___Optional[typing___Iterable[influxdb_service_sdk___model___monitor___alert_dims_pb2___AlertDims]] = None,
        rule_priority : typing___Optional[builtin___int] = None,
        alert_conditions : typing___Optional[influxdb_service_sdk___model___monitor___alert_conditions_pb2___AlertConditions] = None,
