...
from influxdb_service_sdk.model.flowable_service.bpmn_links_pb2 import (
    BPMNLinks as influxdb_service_sdk___model___flowable_service___bpmn_links_pb2___BPMNLinks,
)

from influxdb_service_sdk.model.flowable_service.process_variable_pb2 import (
    ProcessVariable as influxdb_service_sdk___model___flowable_service___process_variable_pb2___ProcessVariable,
)
...
class BPMNUserTask(google___protobuf___message___Message):
    ...
    class ProcessOp(google___protobuf___message___Message):
        ...
        @property
        def conditionExpression(self) -> influxdb_service_sdk___model___flowable_service___process_variable_pb2___ProcessVariable: ...

        def __init__(self,
            *,
            name : typing___Optional[typing___Text] = None,
            conditionExpression : typing___Optional[influxdb_service_sdk___model___flowable_service___process_variable_pb2___ProcessVariable] = None,
    ...
    @property
    def links(self) -> influxdb_service_sdk___model___flowable_service___bpmn_links_pb2___BPMNLinks: ...
    ...
    def __init__(self,
        *,
        ...
        name : typing___Optional[typing___Text] = None,
        links : typing___Optional[influxdb_service_sdk___model___flowable_service___bpmn_links_pb2___BPMNLinks] = None,
