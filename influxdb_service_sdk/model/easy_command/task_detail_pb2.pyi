...
from influxdb_service_sdk.model.easy_command.target_log_pb2 import (
    TargetLog as influxdb_service_sdk___model___easy_command___target_log_pb2___TargetLog,
)
...
class TaskDetail(google___protobuf___message___Message):
    ...
    @property
    def targetsLog(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[influxdb_service_sdk___model___easy_command___target_log_pb2___TargetLog]: ...
    ...
    def __init__(self,
        *,
        ...
        targetsLog : typing___Optional[typing___Iterable[influxdb_service_sdk___model___easy_command___target_log_pb2___TargetLog]] = None,
        ) -> None: ...
    if sys.version_info >= (3,):
        @classmethod
