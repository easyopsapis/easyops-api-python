...
from influxdb_service_sdk.model.topboard.product_basic_pb2 import (
    ProductBasic as influxdb_service_sdk___model___topboard___product_basic_pb2___ProductBasic,
)
...
class Sprint(google___protobuf___message___Message):
    ...
    @property
    def product(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[influxdb_service_sdk___model___topboard___product_basic_pb2___ProductBasic]: ...

    @property
    def issues(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[influxdb_service_sdk___model___topboard___issue_basic_pb2___IssueBasic]: ...

    def __init__(self,
        *,
        product : typing___Optional[typing___Iterable[influxdb_service_sdk___model___topboard___product_basic_pb2___ProductBasic]] = None,
        issues : typing___Optional[typing___Iterable[influxdb_service_sdk___model___topboard___issue_basic_pb2___IssueBasic]] = None,
