...
from ucpro_sdk.model.topology import strategy_pb2 as ucpro__sdk_dot_model_dot_topology_dot_strategy__pb2
from ucpro_sdk.model.topology import cmdb_instance_pb2 as ucpro__sdk_dot_model_dot_topology_dot_cmdb__instance__pb2
...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  serialized_pb=_b('\n\x0eproperty.proto\x12\x08topology\x1a\'ucpro_sdk/model/topology/strategy.proto\x1a,ucpro_sdk/model/topology/cmdb_instance.proto\"\x87\x01\n\x08Property\x12\x10\n\x08objectId\x18\x01 \x01(\t\x12\x12\n\ninstanceId\x18\x02 \x01(\t\x12$\n\x08strategy\x18\x03 \x01(\x0b\x32\x12.topology.Strategy\x12/\n\x0frelateInstances\x18\x04 \x03(\x0b\x32\x16.topology.CmdbInstanceBDZBgo.easyops.local/contracts/protorepo-models/easyops/model/topologyb\x06proto3')
  ,
  dependencies=[ucpro__sdk_dot_model_dot_topology_dot_strategy__pb2.DESCRIPTOR,ucpro__sdk_dot_model_dot_topology_dot_cmdb__instance__pb2.DESCRIPTOR,])
...
_PROPERTY.fields_by_name['strategy'].message_type = ucpro__sdk_dot_model_dot_topology_dot_strategy__pb2._STRATEGY
_PROPERTY.fields_by_name['relateInstances'].message_type = ucpro__sdk_dot_model_dot_topology_dot_cmdb__instance__pb2._CMDBINSTANCE
