...
class InstalledMicroApp(google___protobuf___message___Message):
    ...
    class Icons(google___protobuf___message___Message):
        ...
        if sys.version_info >= (3,):
            @classmethod
            def FromString(cls, s: builtin___bytes) -> InstalledMicroApp.Icons: ...
        else:
            @classmethod
            def FromString(cls, s: typing___Union[builtin___bytes, builtin___buffer, builtin___unicode]) -> InstalledMicroApp.Icons: ...
    ...
    class ClonedFrom(google___protobuf___message___Message):
        ...
        if sys.version_info >= (3,):
            @classmethod
            def FromString(cls, s: builtin___bytes) -> InstalledMicroApp.ClonedFrom: ...
        else:
            @classmethod
            def FromString(cls, s: typing___Union[builtin___bytes, builtin___buffer, builtin___unicode]) -> InstalledMicroApp.ClonedFrom: ...
        def MergeFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
        def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    ...
    class MenuIcon(google___protobuf___message___Message):
        ...
        if sys.version_info >= (3,):
            @classmethod
            def FromString(cls, s: builtin___bytes) -> InstalledMicroApp.MenuIcon: ...
        else:
            @classmethod
            def FromString(cls, s: typing___Union[builtin___bytes, builtin___buffer, builtin___unicode]) -> InstalledMicroApp.MenuIcon: ...
        def MergeFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
        def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    ...
    @property
    def clonedFrom(self) -> InstalledMicroApp.ClonedFrom: ...

    @property
    def menuIcon(self) -> InstalledMicroApp.MenuIcon: ...
    ...
    def __init__(self,
        *,
        ...
        clonedFrom : typing___Optional[InstalledMicroApp.ClonedFrom] = None,
        ...
        menuIcon : typing___Optional[InstalledMicroApp.MenuIcon] = None,
    ...
    if sys.version_info >= (3,):
        @classmethod
        def FromString(cls, s: builtin___bytes) -> InstalledMicroApp: ...
    else:
        @classmethod
        def FromString(cls, s: typing___Union[builtin___bytes, builtin___buffer, builtin___unicode]) -> InstalledMicroApp: ...
    def MergeFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
