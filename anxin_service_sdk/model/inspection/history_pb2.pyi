...
import sys
from anxin_service_sdk.model.inspection.target_pb2 import (
    InspectionTarget as anxin_service_sdk___model___inspection___target_pb2___InspectionTarget,
)
...
class InspectionHistory(google___protobuf___message___Message):
    ...
    @property
    def targets(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[anxin_service_sdk___model___inspection___target_pb2___InspectionTarget]: ...
    ...
    def __init__(self,
        *,
        ...
        targets : typing___Optional[typing___Iterable[anxin_service_sdk___model___inspection___target_pb2___InspectionTarget]] = None,
        ) -> None: ...
    if sys.version_info >= (3,):
        @classmethod
