...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  serialized_pb=_b('\n\x1doperation_log_with_meta.proto\x12\x06notify\x1a\x32\x61nxin_service_sdk/model/notify/operation_log.proto\"Y\n\x14OperationLogWithMeta\x12\x0e\n\x06system\x18\x01 \x01(\t\x12\r\n\x05topic\x18\x02 \x01(\t\x12\"\n\x04\x64\x61ta\x18\x03 \x01(\x0b\x32\x14.notify.OperationLogBBZ@go.easyops.local/contracts/protorepo-models/easyops/model/notifyb\x06proto3')
  ,
  dependencies=[anxin__service__sdk_dot_model_dot_notify_dot_operation__log__pb2.DESCRIPTOR,])
...
_OPERATIONLOGWITHMETA.fields_by_name['data'].message_type = anxin__service__sdk_dot_model_dot_notify_dot_operation__log__pb2._OPERATIONLOG
