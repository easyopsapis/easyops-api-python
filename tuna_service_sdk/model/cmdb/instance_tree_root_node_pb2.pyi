...
from tuna_service_sdk.model.cmdb.instance_tree_child_node_pb2 import (
    InstanceTreeChildNode as tuna_service_sdk___model___cmdb___instance_tree_child_node_pb2___InstanceTreeChildNode,
)
...
class InstanceTreeRootNode(google___protobuf___message___Message):
    ...
    @property
    def child(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[tuna_service_sdk___model___cmdb___instance_tree_child_node_pb2___InstanceTreeChildNode]: ...
    ...
    def __init__(self,
        *,
        ...
        child : typing___Optional[typing___Iterable[tuna_service_sdk___model___cmdb___instance_tree_child_node_pb2___InstanceTreeChildNode]] = None,
        ) -> None: ...
    if sys.version_info >= (3,):
        @classmethod
