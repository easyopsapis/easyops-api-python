...
from tuna_service_sdk.model.container.key_to_path_pb2 import (
    KeyToPath as tuna_service_sdk___model___container___key_to_path_pb2___KeyToPath,
)
...
class Volume(google___protobuf___message___Message):
    ...
    class Secret(google___protobuf___message___Message):
        ...
        @property
        def items(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[tuna_service_sdk___model___container___key_to_path_pb2___KeyToPath]: ...

        def __init__(self,
            *,
            secretName : typing___Optional[typing___Text] = None,
            items : typing___Optional[typing___Iterable[tuna_service_sdk___model___container___key_to_path_pb2___KeyToPath]] = None,
