...
class ProcessDefinitionVersion(google___protobuf___message___Message):
    ...
    @property
    def userTaskList(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[state_workflow_sdk___model___flowable_service___bpmn_user_task_pb2___BPMNUserTask]: ...
    ...
    def __init__(self,
        *,
        ...
        userTaskList : typing___Optional[typing___Iterable[state_workflow_sdk___model___flowable_service___bpmn_user_task_pb2___BPMNUserTask]] = None,
        ) -> None: ...
    if sys.version_info >= (3,):
        @classmethod
