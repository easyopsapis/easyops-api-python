...
from state_workflow_sdk.model.cmdb_extend.subsystem_dependency_pb2 import (
    SubsystemDependency as state_workflow_sdk___model___cmdb_extend___subsystem_dependency_pb2___SubsystemDependency,
)
...
class SystemDependency(google___protobuf___message___Message):
    ...
    @property
    def subsystems(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[state_workflow_sdk___model___cmdb_extend___subsystem_dependency_pb2___SubsystemDependency]: ...
    ...
    def __init__(self,
        *,
        ...
        subsystems : typing___Optional[typing___Iterable[state_workflow_sdk___model___cmdb_extend___subsystem_dependency_pb2___SubsystemDependency]] = None,
        ) -> None: ...
    if sys.version_info >= (3,):
        @classmethod
