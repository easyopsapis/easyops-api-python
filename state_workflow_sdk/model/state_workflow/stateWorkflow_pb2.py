...
_STATEWORKFLOW.fields_by_name['states'].message_type = state__workflow__sdk_dot_model_dot_state__workflow_dot_state__pb2._STATE
_STATEWORKFLOW.fields_by_name['stateTriggers'].message_type = _STATEWORKFLOW_STATETRIGGERS
_STATEWORKFLOW.fields_by_name['transitions'].message_type = state__workflow__sdk_dot_model_dot_state__workflow_dot_transition__pb2._TRANSITION
