...
import sys
from api_gateway_sdk.model.topology.nodeStyle_pb2 import (
    NodeStyle as api_gateway_sdk___model___topology___nodeStyle_pb2___NodeStyle,
)
...
class Node(google___protobuf___message___Message):
    ...
    @property
    def style(self) -> api_gateway_sdk___model___topology___nodeStyle_pb2___NodeStyle: ...
    ...
    def __init__(self,
        *,
        ...
        style : typing___Optional[api_gateway_sdk___model___topology___nodeStyle_pb2___NodeStyle] = None,
        ) -> None: ...
    if sys.version_info >= (3,):
        @classmethod
