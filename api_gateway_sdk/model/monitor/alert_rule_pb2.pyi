...
import sys
from api_gateway_sdk.model.monitor.alert_conditions_pb2 import (
    AlertConditions as api_gateway_sdk___model___monitor___alert_conditions_pb2___AlertConditions,
)

from api_gateway_sdk.model.monitor.alert_dims_pb2 import (
    AlertDims as api_gateway_sdk___model___monitor___alert_dims_pb2___AlertDims,
)
...
class AlertRule(google___protobuf___message___Message):
    ...
    @property
    def alert_dims(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[api_gateway_sdk___model___monitor___alert_dims_pb2___AlertDims]: ...

    @property
    def alert_conditions(self) -> api_gateway_sdk___model___monitor___alert_conditions_pb2___AlertConditions: ...
    ...
    def __init__(self,
        *,
        ...
        alert_dims : typing___Optional[typing___Iterable[api_gateway_sdk___model___monitor___alert_dims_pb2___AlertDims]] = None,
        rule_priority : typing___Optional[builtin___int] = None,
        alert_conditions : typing___Optional[api_gateway_sdk___model___monitor___alert_conditions_pb2___AlertConditions] = None,
