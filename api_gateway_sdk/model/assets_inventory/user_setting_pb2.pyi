...
class InventoryUserSetting(google___protobuf___message___Message):
    ...
    class DetailDisplayList(google___protobuf___message___Message):
        ...
        if sys.version_info >= (3,):
            @classmethod
            def FromString(cls, s: builtin___bytes) -> InventoryUserSetting.DetailDisplayList: ...
        else:
            @classmethod
            def FromString(cls, s: typing___Union[builtin___bytes, builtin___buffer, builtin___unicode]) -> InventoryUserSetting.DetailDisplayList: ...
    ...
    @property
    def detail_display_list(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[InventoryUserSetting.DetailDisplayList]: ...
    ...
    def __init__(self,
        *,
        ...
        detail_display_list : typing___Optional[typing___Iterable[InventoryUserSetting.DetailDisplayList]] = None,
        ) -> None: ...
    if sys.version_info >= (3,):
        @classmethod
        def FromString(cls, s: builtin___bytes) -> InventoryUserSetting: ...
    else:
        @classmethod
        def FromString(cls, s: typing___Union[builtin___bytes, builtin___buffer, builtin___unicode]) -> InventoryUserSetting: ...
    def MergeFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
