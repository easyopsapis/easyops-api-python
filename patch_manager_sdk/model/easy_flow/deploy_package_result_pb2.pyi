...
class DeployPackageResult(google___protobuf___message___Message):
    ...
    @property
    def param(self) -> patch_manager_sdk___model___easy_flow___package_info_pb2___PackageInfo: ...
    ...
    def __init__(self,
        *,
        ...
        param : typing___Optional[patch_manager_sdk___model___easy_flow___package_info_pb2___PackageInfo] = None,
        ) -> None: ...
    if sys.version_info >= (3,):
        @classmethod
