...
from patch_manager_sdk.model.monitor.alert_dims_pb2 import (
    AlertDims as patch_manager_sdk___model___monitor___alert_dims_pb2___AlertDims,
)
...
class AlertRule(google___protobuf___message___Message):
    ...
    @property
    def alert_dims(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[patch_manager_sdk___model___monitor___alert_dims_pb2___AlertDims]: ...
    ...
    def __init__(self,
        *,
        ...
        alert_dims : typing___Optional[typing___Iterable[patch_manager_sdk___model___monitor___alert_dims_pb2___AlertDims]] = None,
