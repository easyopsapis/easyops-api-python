...
from patch_manager_sdk.model.easy_command.action_pb2 import (
    Action as patch_manager_sdk___model___easy_command___action_pb2___Action,
)

from patch_manager_sdk.model.easy_command.target_pb2 import (
    Target as patch_manager_sdk___model___easy_command___target_pb2___Target,
)

from patch_manager_sdk.model.easy_command.task_callback_pb2 import (
    TaskCallback as patch_manager_sdk___model___easy_command___task_callback_pb2___TaskCallback,
)
...
class TaskSpec(google___protobuf___message___Message):
    ...
    @property
    def actions(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[patch_manager_sdk___model___easy_command___action_pb2___Action]: ...

    @property
    def targets(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[patch_manager_sdk___model___easy_command___target_pb2___Target]: ...

    @property
    def callback(self) -> patch_manager_sdk___model___easy_command___task_callback_pb2___TaskCallback: ...
    ...
    def __init__(self,
        *,
        ...
        actions : typing___Optional[typing___Iterable[patch_manager_sdk___model___easy_command___action_pb2___Action]] = None,
        targets : typing___Optional[typing___Iterable[patch_manager_sdk___model___easy_command___target_pb2___Target]] = None,
        ...
        callback : typing___Optional[patch_manager_sdk___model___easy_command___task_callback_pb2___TaskCallback] = None,
