...
from monitor_sdk.model.monitor.alert_conditions_pb2 import (
    AlertConditions as monitor_sdk___model___monitor___alert_conditions_pb2___AlertConditions,
)

from monitor_sdk.model.monitor.alert_dims_pb2 import (
    AlertDims as monitor_sdk___model___monitor___alert_dims_pb2___AlertDims,
)
...
class AlertRule(google___protobuf___message___Message):
    ...
    @property
    def alert_dims(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[monitor_sdk___model___monitor___alert_dims_pb2___AlertDims]: ...

    @property
    def alert_conditions(self) -> monitor_sdk___model___monitor___alert_conditions_pb2___AlertConditions: ...
    ...
    def __init__(self,
        *,
        ...
        alert_dims : typing___Optional[typing___Iterable[monitor_sdk___model___monitor___alert_dims_pb2___AlertDims]] = None,
        rule_priority : typing___Optional[builtin___int] = None,
        alert_conditions : typing___Optional[monitor_sdk___model___monitor___alert_conditions_pb2___AlertConditions] = None,
