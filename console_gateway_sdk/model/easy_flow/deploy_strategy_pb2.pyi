...
import sys
from console_gateway_sdk.model.cmdb.cluster_info_pb2 import (
    ClusterInfo as console_gateway_sdk___model___cmdb___cluster_info_pb2___ClusterInfo,
)

from console_gateway_sdk.model.easy_flow.deploy_target_pb2 import (
    DeployTarget as console_gateway_sdk___model___easy_flow___deploy_target_pb2___DeployTarget,
)

from console_gateway_sdk.model.easy_flow.target_info_pb2 import (
    TargetInfo as console_gateway_sdk___model___easy_flow___target_info_pb2___TargetInfo,
)
...
class DeployStrategy(google___protobuf___message___Message):
    ...
    class BatchStrategy(google___protobuf___message___Message):
        ...
        class ManualBatch(google___protobuf___message___Message):
            ...
            class Batches(google___protobuf___message___Message):
                ...
                @property
                def targets(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[console_gateway_sdk___model___easy_flow___deploy_target_pb2___DeployTarget]: ...

                def __init__(self,
                    *,
                    targets : typing___Optional[typing___Iterable[console_gateway_sdk___model___easy_flow___deploy_target_pb2___DeployTarget]] = None,
                    ) -> None: ...
                if sys.version_info >= (3,):
                    @classmethod
    ...
    class PackageList(google___protobuf___message___Message):
        ...
        @property
        def cluster(self) -> console_gateway_sdk___model___cmdb___cluster_info_pb2___ClusterInfo: ...

        def __init__(self,
            *,
            packageName : typing___Optional[typing___Text] = None,
            cluster : typing___Optional[console_gateway_sdk___model___cmdb___cluster_info_pb2___ClusterInfo] = None,
    ...
    @property
    def clusters(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[console_gateway_sdk___model___cmdb___cluster_info_pb2___ClusterInfo]: ...

    @property
    def targetList(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[console_gateway_sdk___model___easy_flow___target_info_pb2___TargetInfo]: ...
    ...
    def __init__(self,
        *,
        ...
        clusters : typing___Optional[typing___Iterable[console_gateway_sdk___model___cmdb___cluster_info_pb2___ClusterInfo]] = None,
        targetList : typing___Optional[typing___Iterable[console_gateway_sdk___model___easy_flow___target_info_pb2___TargetInfo]] = None,
