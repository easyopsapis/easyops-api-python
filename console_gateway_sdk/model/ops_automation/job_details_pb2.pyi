...
import sys
from console_gateway_sdk.model.ops_automation.bind_resource_pb2 import (
    BindResource as console_gateway_sdk___model___ops_automation___bind_resource_pb2___BindResource,
)

from console_gateway_sdk.model.ops_automation.mail_info_pb2 import (
    MailInfo as console_gateway_sdk___model___ops_automation___mail_info_pb2___MailInfo,
)
...
class JobDetails(google___protobuf___message___Message):
    ...
    @property
    def bindResource(self) -> console_gateway_sdk___model___ops_automation___bind_resource_pb2___BindResource: ...

    @property
    def mail(self) -> console_gateway_sdk___model___ops_automation___mail_info_pb2___MailInfo: ...
    ...
    def __init__(self,
        *,
        ...
        bindResource : typing___Optional[console_gateway_sdk___model___ops_automation___bind_resource_pb2___BindResource] = None,
        desc : typing___Optional[typing___Text] = None,
        allowModify : typing___Optional[builtin___bool] = None,
        mail : typing___Optional[console_gateway_sdk___model___ops_automation___mail_info_pb2___MailInfo] = None,
