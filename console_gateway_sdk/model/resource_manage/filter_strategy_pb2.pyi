...
import sys
from console_gateway_sdk.model.console.cmdb_query_strategy_pb2 import (
    CmdbQueryStrategy as console_gateway_sdk___model___console___cmdb_query_strategy_pb2___CmdbQueryStrategy,
)

from console_gateway_sdk.model.resource_manage.filter_condition_group_pb2 import (
    FilterConditionGroup as console_gateway_sdk___model___resource_manage___filter_condition_group_pb2___FilterConditionGroup,
)
...
class FilterStrategy(google___protobuf___message___Message):
    ...
    @property
    def query(self) -> console_gateway_sdk___model___console___cmdb_query_strategy_pb2___CmdbQueryStrategy: ...

    @property
    def filter(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[console_gateway_sdk___model___resource_manage___filter_condition_group_pb2___FilterConditionGroup]: ...
    ...
    def __init__(self,
        *,
        ...
        query : typing___Optional[console_gateway_sdk___model___console___cmdb_query_strategy_pb2___CmdbQueryStrategy] = None,
        filter : typing___Optional[typing___Iterable[console_gateway_sdk___model___resource_manage___filter_condition_group_pb2___FilterConditionGroup]] = None,
