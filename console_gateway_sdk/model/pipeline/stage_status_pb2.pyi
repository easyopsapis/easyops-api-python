...
import sys
from console_gateway_sdk.model.pipeline.condition_pb2 import (
    Condition as console_gateway_sdk___model___pipeline___condition_pb2___Condition,
)
...
class StageStatus(google___protobuf___message___Message):
    ...
    @property
    def conditions(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[console_gateway_sdk___model___pipeline___condition_pb2___Condition]: ...
    ...
    def __init__(self,
        *,
        ...
        state : typing___Optional[typing___Text] = None,
        conditions : typing___Optional[typing___Iterable[console_gateway_sdk___model___pipeline___condition_pb2___Condition]] = None,
