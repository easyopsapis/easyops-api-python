...
import sys
from console_gateway_sdk.model.permission.permission_pb2 import (
    Permission as console_gateway_sdk___model___permission___permission_pb2___Permission,
)
...
class GetPermissionListRequest(google___protobuf___message___Message):
    ...
    def ClearField(self, field_name: typing_extensions___Literal[u"XXX_RestFieldMask",b"XXX_RestFieldMask",u"action",b"action",u"action__in",b"action__in"]) -> None: ...
...
class GetPermissionListResponse(google___protobuf___message___Message):
    ...
    @property
    def data(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[console_gateway_sdk___model___permission___permission_pb2___Permission]: ...

    def __init__(self,
        *,
        code : typing___Optional[builtin___int] = None,
        data : typing___Optional[typing___Iterable[console_gateway_sdk___model___permission___permission_pb2___Permission]] = None,
        ) -> None: ...
    if sys.version_info >= (3,):
        @classmethod
    ...
    def MergeFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    def ClearField(self, field_name: typing_extensions___Literal[u"code",b"code",u"data",b"data"]) -> None: ...
