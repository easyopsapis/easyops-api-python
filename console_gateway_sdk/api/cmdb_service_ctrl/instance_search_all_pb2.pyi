...
class InstanceSearchAllRequest(google___protobuf___message___Message):
    ...
    if sys.version_info >= (3,):
        @classmethod
        def FromString(cls, s: builtin___bytes) -> InstanceSearchAllRequest: ...
    else:
        @classmethod
        def FromString(cls, s: typing___Union[builtin___bytes, builtin___buffer, builtin___unicode]) -> InstanceSearchAllRequest: ...
    ...
    def ClearField(self, field_name: typing_extensions___Literal[u"fields",b"fields",u"objectId",b"objectId",u"only_my_instance",b"only_my_instance",u"only_relation_view",b"only_relation_view",u"permission",b"permission",u"query",b"query",u"sort",b"sort"]) -> None: ...

class InstanceSearchAllResponse(google___protobuf___message___Message):
    DESCRIPTOR: google___protobuf___descriptor___Descriptor = ...
    ...
    if sys.version_info >= (3,):
        @classmethod
        def FromString(cls, s: builtin___bytes) -> InstanceSearchAllResponse: ...
    else:
        @classmethod
        def FromString(cls, s: typing___Union[builtin___bytes, builtin___buffer, builtin___unicode]) -> InstanceSearchAllResponse: ...
    def MergeFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
...
class InstanceSearchAllResponseWrapper(google___protobuf___message___Message):
    DESCRIPTOR: google___protobuf___descriptor___Descriptor = ...
    code = ... # type: builtin___int
    ...
    @property
    def data(self) -> InstanceSearchAllResponse: ...
    ...
    def __init__(self,
        *,
        ...
        error : typing___Optional[typing___Text] = None,
        data : typing___Optional[InstanceSearchAllResponse] = None,
        ) -> None: ...
    if sys.version_info >= (3,):
        @classmethod
        def FromString(cls, s: builtin___bytes) -> InstanceSearchAllResponseWrapper: ...
    else:
        @classmethod
        def FromString(cls, s: typing___Union[builtin___bytes, builtin___buffer, builtin___unicode]) -> InstanceSearchAllResponseWrapper: ...
    def MergeFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
