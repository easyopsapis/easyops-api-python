...
class SearchSubSystemAllRequest(google___protobuf___message___Message):
    ...
    if sys.version_info >= (3,):
        @classmethod
        def FromString(cls, s: builtin___bytes) -> SearchSubSystemAllRequest: ...
    else:
        @classmethod
        def FromString(cls, s: typing___Union[builtin___bytes, builtin___buffer, builtin___unicode]) -> SearchSubSystemAllRequest: ...
    ...
    def ClearField(self, field_name: typing_extensions___Literal[u"fields",b"fields",u"only_my_instance",b"only_my_instance",u"only_relation_view",b"only_relation_view",u"permission",b"permission",u"query",b"query",u"sort",b"sort",u"systemInstanceId",b"systemInstanceId"]) -> None: ...

class SearchSubSystemAllResponse(google___protobuf___message___Message):
    DESCRIPTOR: google___protobuf___descriptor___Descriptor = ...
    ...
    if sys.version_info >= (3,):
        @classmethod
        def FromString(cls, s: builtin___bytes) -> SearchSubSystemAllResponse: ...
    else:
        @classmethod
        def FromString(cls, s: typing___Union[builtin___bytes, builtin___buffer, builtin___unicode]) -> SearchSubSystemAllResponse: ...
    def MergeFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
...
class SearchSubSystemAllResponseWrapper(google___protobuf___message___Message):
    DESCRIPTOR: google___protobuf___descriptor___Descriptor = ...
    code = ... # type: builtin___int
    ...
    @property
    def data(self) -> SearchSubSystemAllResponse: ...
    ...
    def __init__(self,
        *,
        ...
        error : typing___Optional[typing___Text] = None,
        data : typing___Optional[SearchSubSystemAllResponse] = None,
        ) -> None: ...
    if sys.version_info >= (3,):
        @classmethod
        def FromString(cls, s: builtin___bytes) -> SearchSubSystemAllResponseWrapper: ...
    else:
        @classmethod
        def FromString(cls, s: typing___Union[builtin___bytes, builtin___buffer, builtin___unicode]) -> SearchSubSystemAllResponseWrapper: ...
    def MergeFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
