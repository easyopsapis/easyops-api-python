...
from webshell_sdk.model.container.ingress_rule_pb2 import (
    IngressRule as webshell_sdk___model___container___ingress_rule_pb2___IngressRule,
)

from webshell_sdk.model.container.ingress_tls_pb2 import (
    IngressTLS as webshell_sdk___model___container___ingress_tls_pb2___IngressTLS,
)
...
class Ingress(google___protobuf___message___Message):
    ...
    @property
    def rules(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[webshell_sdk___model___container___ingress_rule_pb2___IngressRule]: ...

    @property
    def tls(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[webshell_sdk___model___container___ingress_tls_pb2___IngressTLS]: ...
    ...
    def __init__(self,
        *,
        ...
        rules : typing___Optional[typing___Iterable[webshell_sdk___model___container___ingress_rule_pb2___IngressRule]] = None,
        tls : typing___Optional[typing___Iterable[webshell_sdk___model___container___ingress_tls_pb2___IngressTLS]] = None,
