...
from inspection_sdk.model.container.resource_metric_source_pb2 import (
    ResourceMetricSource as inspection_sdk___model___container___resource_metric_source_pb2___ResourceMetricSource,
)
...
class HorizontalPodAutoscaler(google___protobuf___message___Message):
    ...
    class Metrics(google___protobuf___message___Message):
        ...
        @property
        def resource(self) -> inspection_sdk___model___container___resource_metric_source_pb2___ResourceMetricSource: ...

        def __init__(self,
            *,
            type : typing___Optional[typing___Text] = None,
            resource : typing___Optional[inspection_sdk___model___container___resource_metric_source_pb2___ResourceMetricSource] = None,
            ) -> None: ...
        if sys.version_info >= (3,):
            @classmethod
