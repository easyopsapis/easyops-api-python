...
from inspection_sdk.model.next_builder.micro_app_project_pb2 import (
    MicroAppProject as inspection_sdk___model___next_builder___micro_app_project_pb2___MicroAppProject,
)

from inspection_sdk.model.next_builder.storyboard_brick_pb2 import (
    StoryboardBrick as inspection_sdk___model___next_builder___storyboard_brick_pb2___StoryboardBrick,
)

from inspection_sdk.model.next_builder.storyboard_route_pb2 import (
    StoryboardRoute as inspection_sdk___model___next_builder___storyboard_route_pb2___StoryboardRoute,
)
...
class StoryboardNode(google___protobuf___message___Message):
    ...
    @property
    def brick(self) -> inspection_sdk___model___next_builder___storyboard_brick_pb2___StoryboardBrick: ...

    @property
    def route(self) -> inspection_sdk___model___next_builder___storyboard_route_pb2___StoryboardRoute: ...

    @property
    def project(self) -> inspection_sdk___model___next_builder___micro_app_project_pb2___MicroAppProject: ...
    ...
    def __init__(self,
        *,
        ...
        brick : typing___Optional[inspection_sdk___model___next_builder___storyboard_brick_pb2___StoryboardBrick] = None,
        route : typing___Optional[inspection_sdk___model___next_builder___storyboard_route_pb2___StoryboardRoute] = None,
        project : typing___Optional[inspection_sdk___model___next_builder___micro_app_project_pb2___MicroAppProject] = None,
