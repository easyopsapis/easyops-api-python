...
_TOOLTASK_EXTRADETAIL_TOOLOUTPUTS_DIMENSIONS = _descriptor.Descriptor(
  name='Dimensions',
  full_name='tool.ToolTask.ExtraDetail.ToolOutputs.Dimensions',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='id', full_name='tool.ToolTask.ExtraDetail.ToolOutputs.Dimensions.id', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='name', full_name='tool.ToolTask.ExtraDetail.ToolOutputs.Dimensions.name', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='type', full_name='tool.ToolTask.ExtraDetail.ToolOutputs.Dimensions.type', index=2,
...
_TOOLTASK_EXTRADETAIL_TOOLOUTPUTS_COLUMNS = _descriptor.Descriptor(
  name='Columns',
  full_name='tool.ToolTask.ExtraDetail.ToolOutputs.Columns',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='id', full_name='tool.ToolTask.ExtraDetail.ToolOutputs.Columns.id', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='name', full_name='tool.ToolTask.ExtraDetail.ToolOutputs.Columns.name', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='type', full_name='tool.ToolTask.ExtraDetail.ToolOutputs.Columns.type', index=2,
      number=3, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_TOOLTASK_EXTRADETAIL_TOOLOUTPUTS = _descriptor.Descriptor(
  name='ToolOutputs',
  full_name='tool.ToolTask.ExtraDetail.ToolOutputs',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='dimensions', full_name='tool.ToolTask.ExtraDetail.ToolOutputs.dimensions', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='columns', full_name='tool.ToolTask.ExtraDetail.ToolOutputs.columns', index=1,
  ...
  nested_types=[_TOOLTASK_EXTRADETAIL_TOOLOUTPUTS_DIMENSIONS, _TOOLTASK_EXTRADETAIL_TOOLOUTPUTS_COLUMNS, ],
  enum_types=[
  ],
  serialized_options=None,
  is_extendable=False,
...
_TOOLTASK_EXTRADETAIL = _descriptor.Descriptor(
  ...
  nested_types=[_TOOLTASK_EXTRADETAIL_TOOLOUTPUTS, _TOOLTASK_EXTRADETAIL_TABLEDEFS, _TOOLTASK_EXTRADETAIL_OUTPUTDEFS, ],
  enum_types=[
  ],
  serialized_options=None,
  is_extendable=False,
...
_TOOLTASK_EXTRADETAIL_TOOLOUTPUTS_DIMENSIONS.containing_type = _TOOLTASK_EXTRADETAIL_TOOLOUTPUTS
_TOOLTASK_EXTRADETAIL_TOOLOUTPUTS_COLUMNS.containing_type = _TOOLTASK_EXTRADETAIL_TOOLOUTPUTS
_TOOLTASK_EXTRADETAIL_TOOLOUTPUTS.fields_by_name['dimensions'].message_type = _TOOLTASK_EXTRADETAIL_TOOLOUTPUTS_DIMENSIONS
_TOOLTASK_EXTRADETAIL_TOOLOUTPUTS.fields_by_name['columns'].message_type = _TOOLTASK_EXTRADETAIL_TOOLOUTPUTS_COLUMNS
_TOOLTASK_EXTRADETAIL_TOOLOUTPUTS.containing_type = _TOOLTASK_EXTRADETAIL
...
_TOOLTASK_EXTRADETAIL.fields_by_name['callback'].message_type = model_dot_tool_dot_callback__pb2._CALLBACK
_TOOLTASK_EXTRADETAIL.fields_by_name['toolEnv'].message_type = google_dot_protobuf_dot_struct__pb2._STRUCT
_TOOLTASK_EXTRADETAIL.fields_by_name['toolOutputs'].message_type = _TOOLTASK_EXTRADETAIL_TOOLOUTPUTS
...
ToolTask = _reflection.GeneratedProtocolMessageType('ToolTask', (_message.Message,), dict(
  ...
  ExtraDetail = _reflection.GeneratedProtocolMessageType('ExtraDetail', (_message.Message,), dict(
    ...
    ToolOutputs = _reflection.GeneratedProtocolMessageType('ToolOutputs', (_message.Message,), dict(
      ...
      Dimensions = _reflection.GeneratedProtocolMessageType('Dimensions', (_message.Message,), dict(
        DESCRIPTOR = _TOOLTASK_EXTRADETAIL_TOOLOUTPUTS_DIMENSIONS,
        __module__ = 'tool_task_pb2'
        # @@protoc_insertion_point(class_scope:tool.ToolTask.ExtraDetail.ToolOutputs.Dimensions)
        ))
      ,

      Columns = _reflection.GeneratedProtocolMessageType('Columns', (_message.Message,), dict(
        DESCRIPTOR = _TOOLTASK_EXTRADETAIL_TOOLOUTPUTS_COLUMNS,
        __module__ = 'tool_task_pb2'
        # @@protoc_insertion_point(class_scope:tool.ToolTask.ExtraDetail.ToolOutputs.Columns)
        ))
      ,
      DESCRIPTOR = _TOOLTASK_EXTRADETAIL_TOOLOUTPUTS,
      __module__ = 'tool_task_pb2'
      # @@protoc_insertion_point(class_scope:tool.ToolTask.ExtraDetail.ToolOutputs)
      ))
    ,
...
_sym_db.RegisterMessage(ToolTask.ExtraDetail.ToolOutputs)
_sym_db.RegisterMessage(ToolTask.ExtraDetail.ToolOutputs.Dimensions)
_sym_db.RegisterMessage(ToolTask.ExtraDetail.ToolOutputs.Columns)
