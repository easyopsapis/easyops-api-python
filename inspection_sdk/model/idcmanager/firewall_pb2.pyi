...
class Firewall(google___protobuf___message___Message):
    ...
    if sys.version_info >= (3,):
        @classmethod
        def FromString(cls, s: builtin___bytes) -> Firewall: ...
    else:
        @classmethod
        def FromString(cls, s: typing___Union[builtin___bytes, builtin___buffer, builtin___unicode]) -> Firewall: ...
    def MergeFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    def ClearField(self, field_name: typing_extensions___Literal[u"_occupiedU",b"_occupiedU",u"_startU",b"_startU",u"creator",b"creator",u"ctime",b"ctime",u"customer",b"customer",u"instanceId",b"instanceId",u"ip",b"ip",u"isSinglePower",b"isSinglePower",u"memo",b"memo",u"name",b"name",u"product",b"product"]) -> None: ...
