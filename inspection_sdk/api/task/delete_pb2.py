...
_DELETETASKREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='id', full_name='task.DeleteTaskRequest.id', index=0,
...
DeleteTaskResponseWrapper = _reflection.GeneratedProtocolMessageType('DeleteTaskResponseWrapper', (_message.Message,), dict(
