...
from inspection_sdk.model.inspection import task_pb2 as inspection__sdk_dot_model_dot_inspection_dot_task__pb2
...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  serialized_pb=_b('\n\tget.proto\x12\x04task\x1a\x38inspection_sdk/model/inspection/user_or_user_group.proto\x1a*inspection_sdk/model/inspection/task.proto\"<\n\x0eGetTaskRequest\x12\x10\n\x08pluginId\x18\x01 \x01(\t\x12\x18\n\x10inspectionTaskId\x18\x02 \x01(\t\"t\n\x16GetTaskResponseWrapper\x12\x0c\n\x04\x63ode\x18\x01 \x01(\x05\x12\x13\n\x0b\x63odeExplain\x18\x02 \x01(\t\x12\r\n\x05\x65rror\x18\x03 \x01(\t\x12(\n\x04\x64\x61ta\x18\x04 \x01(\x0b\x32\x1a.inspection.InspectionTaskb\x06proto3')
  ,
  dependencies=[inspection__sdk_dot_model_dot_inspection_dot_user__or__user__group__pb2.DESCRIPTOR,inspection__sdk_dot_model_dot_inspection_dot_task__pb2.DESCRIPTOR,])
...
_GETTASKREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='pluginId', full_name='task.GetTaskRequest.pluginId', index=0,
...
_GETTASKRESPONSEWRAPPER.fields_by_name['data'].message_type = inspection__sdk_dot_model_dot_inspection_dot_task__pb2._INSPECTIONTASK
