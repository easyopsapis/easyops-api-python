...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  serialized_pb=_b('\n\x19listen_org_register.proto\x12\x04info\x1a\x1bgoogle/protobuf/empty.proto\"z\n ListenOrgRegisterResponseWrapper\x12\x0c\n\x04\x63ode\x18\x01 \x01(\x05\x12\x13\n\x0b\x63odeExplain\x18\x02 \x01(\t\x12\r\n\x05\x65rror\x18\x03 \x01(\t\x12$\n\x04\x64\x61ta\x18\x04 \x01(\x0b\x32\x16.google.protobuf.Emptyb\x06proto3')
  ,
...
_LISTENORGREGISTERRESPONSEWRAPPER = _descriptor.Descriptor(
  ...
  full_name='info.ListenOrgRegisterResponseWrapper',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='code', full_name='info.ListenOrgRegisterResponseWrapper.code', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='codeExplain', full_name='info.ListenOrgRegisterResponseWrapper.codeExplain', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='error', full_name='info.ListenOrgRegisterResponseWrapper.error', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='data', full_name='info.ListenOrgRegisterResponseWrapper.data', index=3,
...
ListenOrgRegisterResponseWrapper = _reflection.GeneratedProtocolMessageType('ListenOrgRegisterResponseWrapper', (_message.Message,), {
  ...
  # @@protoc_insertion_point(class_scope:info.ListenOrgRegisterResponseWrapper)
  })
