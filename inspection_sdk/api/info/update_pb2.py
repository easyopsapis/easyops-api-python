...
_UPDATEINSPECTIONINFOREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='memo', full_name='info.UpdateInspectionInfoRequest.memo', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='index', full_name='info.UpdateInspectionInfoRequest.index', index=3,
...
_UPDATEINSPECTIONINFORESPONSEWRAPPER.fields_by_name['data'].message_type = inspection__sdk_dot_model_dot_inspection_dot_info__pb2._INSPECTIONINFO
