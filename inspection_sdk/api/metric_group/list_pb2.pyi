...
class ListMetricGroupRequest(google___protobuf___message___Message):
    ...
    @classmethod
    def FromString(cls, s: bytes) -> ListMetricGroupRequest: ...
...
class ListMetricGroupResponse(google___protobuf___message___Message):
    ...
    @property
    def list(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[model___inspection___metric_group_pb2___InspectionMetricGroup]: ...

    def __init__(self,
        page : typing___Optional[int] = None,
        page_size : typing___Optional[int] = None,
        total : typing___Optional[int] = None,
        list : typing___Optional[typing___Iterable[model___inspection___metric_group_pb2___InspectionMetricGroup]] = None,
        ) -> None: ...
    @classmethod
    def FromString(cls, s: bytes) -> ListMetricGroupResponse: ...
    def MergeFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    if sys.version_info >= (3,):
...
class ListMetricGroupResponseWrapper(google___protobuf___message___Message):
    ...
    @classmethod
    def FromString(cls, s: bytes) -> ListMetricGroupResponseWrapper: ...
    def MergeFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    if sys.version_info >= (3,):
