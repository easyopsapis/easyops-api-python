...
_GETSOURCEDATARESPONSEWRAPPER.fields_by_name['data'].message_type = model_dot_inspection_dot_history__pb2._INSPECTIONHISTORY
...
GetSourceDataRequest = _reflection.GeneratedProtocolMessageType('GetSourceDataRequest', (_message.Message,), dict(

  List = _reflection.GeneratedProtocolMessageType('List', (_message.Message,), dict(

    DimList = _reflection.GeneratedProtocolMessageType('DimList', (_message.Message,), dict(
    ...
    ValList = _reflection.GeneratedProtocolMessageType('ValList', (_message.Message,), dict(
...
GetSourceDataResponseWrapper = _reflection.GeneratedProtocolMessageType('GetSourceDataResponseWrapper', (_message.Message,), dict(
