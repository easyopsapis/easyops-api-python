...
_LISTABNORMALMETRICSRESPONSE_LIST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='targetId', full_name='history.ListAbnormalMetricsResponse.List.targetId', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='log', full_name='history.ListAbnormalMetricsResponse.List.log', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='abnormalMetricGroups', full_name='history.ListAbnormalMetricsResponse.List.abnormalMetricGroups', index=2,
...
_LISTABNORMALMETRICSRESPONSE_LIST_ABNORMALMETRICGROUPS.fields_by_name['dims'].message_type = inspection__sdk_dot_model_dot_inspection_dot_dim__pb2._INSPECTIONDIM
...
ListAbnormalMetricsRequest = _reflection.GeneratedProtocolMessageType('ListAbnormalMetricsRequest', (_message.Message,), {
...
ListAbnormalMetricsResponse = _reflection.GeneratedProtocolMessageType('ListAbnormalMetricsResponse', (_message.Message,), {

  'List' : _reflection.GeneratedProtocolMessageType('List', (_message.Message,), {

    'AbnormalMetricGroups' : _reflection.GeneratedProtocolMessageType('AbnormalMetricGroups', (_message.Message,), {

      'AbnormalMetrics' : _reflection.GeneratedProtocolMessageType('AbnormalMetrics', (_message.Message,), {
...
ListAbnormalMetricsResponseWrapper = _reflection.GeneratedProtocolMessageType('ListAbnormalMetricsResponseWrapper', (_message.Message,), {
