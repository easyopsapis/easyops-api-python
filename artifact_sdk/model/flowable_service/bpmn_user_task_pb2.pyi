...
import sys
from artifact_sdk.model.flowable_service.bpmn_links_pb2 import (
    BPMNLinks as artifact_sdk___model___flowable_service___bpmn_links_pb2___BPMNLinks,
)

from artifact_sdk.model.flowable_service.process_variable_pb2 import (
    ProcessVariable as artifact_sdk___model___flowable_service___process_variable_pb2___ProcessVariable,
)
...
class BPMNUserTask(google___protobuf___message___Message):
    ...
    class ProcessOp(google___protobuf___message___Message):
        ...
        @property
        def conditionExpression(self) -> artifact_sdk___model___flowable_service___process_variable_pb2___ProcessVariable: ...

        def __init__(self,
            *,
            name : typing___Optional[typing___Text] = None,
            conditionExpression : typing___Optional[artifact_sdk___model___flowable_service___process_variable_pb2___ProcessVariable] = None,
    ...
    @property
    def links(self) -> artifact_sdk___model___flowable_service___bpmn_links_pb2___BPMNLinks: ...
    ...
    def __init__(self,
        *,
        ...
        name : typing___Optional[typing___Text] = None,
        links : typing___Optional[artifact_sdk___model___flowable_service___bpmn_links_pb2___BPMNLinks] = None,
