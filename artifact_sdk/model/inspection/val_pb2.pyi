...
import sys
from artifact_sdk.model.inspection.condition_pb2 import (
    InspectionCondition as artifact_sdk___model___inspection___condition_pb2___InspectionCondition,
)
...
class InspectionVal(google___protobuf___message___Message):
    ...
    @property
    def conditions(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[artifact_sdk___model___inspection___condition_pb2___InspectionCondition]: ...
    ...
    def __init__(self,
        *,
        ...
        conditions : typing___Optional[typing___Iterable[artifact_sdk___model___inspection___condition_pb2___InspectionCondition]] = None,
        ) -> None: ...
    if sys.version_info >= (3,):
        @classmethod
