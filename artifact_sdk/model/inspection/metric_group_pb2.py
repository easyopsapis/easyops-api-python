...
_INSPECTIONMETRICGROUP.fields_by_name['dims'].message_type = model_dot_inspection_dot_dim__pb2._INSPECTIONDIM
_INSPECTIONMETRICGROUP.fields_by_name['vals'].message_type = model_dot_inspection_dot_val__pb2._INSPECTIONVAL
DESCRIPTOR.message_types_by_name['InspectionMetricGroup'] = _INSPECTIONMETRICGROUP
_sym_db.RegisterFileDescriptor(DESCRIPTOR)

InspectionMetricGroup = _reflection.GeneratedProtocolMessageType('InspectionMetricGroup', (_message.Message,), dict(
