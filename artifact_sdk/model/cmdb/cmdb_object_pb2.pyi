...
import sys
from artifact_sdk.model.cmdb.object_attr_pb2 import (
    ObjectAttr as artifact_sdk___model___cmdb___object_attr_pb2___ObjectAttr,
)

from artifact_sdk.model.cmdb.object_index_pb2 import (
    ObjectIndex as artifact_sdk___model___cmdb___object_index_pb2___ObjectIndex,
)

from artifact_sdk.model.cmdb.object_relation_group_pb2 import (
    ObjectRelationGroup as artifact_sdk___model___cmdb___object_relation_group_pb2___ObjectRelationGroup,
)

from artifact_sdk.model.cmdb.object_relation_pb2 import (
    ObjectRelation as artifact_sdk___model___cmdb___object_relation_pb2___ObjectRelation,
)
...
class CmdbObject(google___protobuf___message___Message):
    ...
    @property
    def attrList(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[artifact_sdk___model___cmdb___object_attr_pb2___ObjectAttr]: ...

    @property
    def relation_list(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[artifact_sdk___model___cmdb___object_relation_pb2___ObjectRelation]: ...

    @property
    def relation_groups(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[artifact_sdk___model___cmdb___object_relation_group_pb2___ObjectRelationGroup]: ...

    @property
    def indexList(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[artifact_sdk___model___cmdb___object_index_pb2___ObjectIndex]: ...
    ...
    def __init__(self,
        *,
        attrList : typing___Optional[typing___Iterable[artifact_sdk___model___cmdb___object_attr_pb2___ObjectAttr]] = None,
        relation_list : typing___Optional[typing___Iterable[artifact_sdk___model___cmdb___object_relation_pb2___ObjectRelation]] = None,
        relation_groups : typing___Optional[typing___Iterable[artifact_sdk___model___cmdb___object_relation_group_pb2___ObjectRelationGroup]] = None,
        indexList : typing___Optional[typing___Iterable[artifact_sdk___model___cmdb___object_index_pb2___ObjectIndex]] = None,
