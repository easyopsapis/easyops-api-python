...
class SchedulerTask(google___protobuf___message___Message):
    ...
    class Annotations(google___protobuf___message___Message):
        ...
        if sys.version_info >= (3,):
            @classmethod
            def FromString(cls, s: builtin___bytes) -> SchedulerTask.Annotations: ...
        else:
            @classmethod
            def FromString(cls, s: typing___Union[builtin___bytes, builtin___buffer, builtin___unicode]) -> SchedulerTask.Annotations: ...
    ...
    class CmdConfig(google___protobuf___message___Message):
        ...
        if sys.version_info >= (3,):
            @classmethod
            def FromString(cls, s: builtin___bytes) -> SchedulerTask.CmdConfig: ...
        else:
            @classmethod
            def FromString(cls, s: typing___Union[builtin___bytes, builtin___buffer, builtin___unicode]) -> SchedulerTask.CmdConfig: ...
        def MergeFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
        def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    ...
    class Callback(google___protobuf___message___Message):
        ...
        if sys.version_info >= (3,):
            @classmethod
            def FromString(cls, s: builtin___bytes) -> SchedulerTask.Callback: ...
        else:
            @classmethod
            def FromString(cls, s: typing___Union[builtin___bytes, builtin___buffer, builtin___unicode]) -> SchedulerTask.Callback: ...
        def MergeFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
        def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    ...
    if sys.version_info >= (3,):
        @classmethod
        def FromString(cls, s: builtin___bytes) -> SchedulerTask: ...
    else:
        @classmethod
        def FromString(cls, s: typing___Union[builtin___bytes, builtin___buffer, builtin___unicode]) -> SchedulerTask: ...
    def MergeFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    ...
    def ClearField(self, field_name: typing_extensions___Literal[u"annotations",b"annotations",u"assignner",b"assignner",u"callback",b"callback",u"cmd_config",b"cmd_config",u"cmd_type",b"cmd_type",u"create_time",b"create_time",u"deleteAuthorizers",b"deleteAuthorizers",u"disable",b"disable",u"error",b"error",u"id",b"id",u"invisible",b"invisible",u"job_id",b"job_id",u"job_type",b"job_type",u"name",b"name",u"operateAuthorizers",b"operateAuthorizers",u"org",b"org",u"src_id",b"src_id",u"status",b"status",u"task_scheduler",b"task_scheduler",u"task_type",b"task_type",u"updateAuthorizers",b"updateAuthorizers",u"update_time",b"update_time",u"user",b"user"]) -> None: ...
