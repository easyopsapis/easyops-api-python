...
class VersionClient(object):
    ...
    def create_version_with_sign(self, request, org, user, timeout=10):
        # type: (create_version_with_sign_pb2.CreateVersionWithSignRequest, int, str, int) -> model.artifact.version_pb2.Version
        """
        创建版本
    ...
    def delete_version(self, request, org, user, timeout=10):
        # type: (delete_version_pb2.DeleteVersionRequest, int, str, int) -> delete_version_pb2.DeleteVersionResponse
        """
        删除版本
    ...
    def get_version_detail(self, request, org, user, timeout=10):
        # type: (get_version_detail_pb2.GetVersionDetailRequest, int, str, int) -> model.artifact.version_pb2.Version
        """
        获取版本详情
    ...
    def get_version_permission_info(self, request, org, user, timeout=10):
        # type: (get_version_permission_info_pb2.GetVersionPermissionInfoRequest, int, str, int) -> model.artifact.white_permission_user_pb2.WhitePermissionUser
        """
        获取版本权限
    ...
    def update(self, request, org, user, timeout=10):
        # type: (update_pb2.UpdateRequest, int, str, int) -> model.artifact.version_pb2.Version
        """
        修改版本信息
    ...
    def update_version_env_type(self, request, org, user, timeout=10):
        # type: (update_version_env_type_pb2.UpdateVersionEnvTypeRequest, int, str, int) -> model.artifact.version_pb2.Version
        """
        更新版本的环境号
    ...
    def update_version_permission_users(self, request, org, user, timeout=10):
        # type: (update_version_permission_users_pb2.UpdateVersionPermissionUsersRequest, int, str, int) -> google.protobuf.empty_pb2.Empty
        """
        创建版本权限
