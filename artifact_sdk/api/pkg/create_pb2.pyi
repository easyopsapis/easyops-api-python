...
class CreateRequest(google___protobuf___message___Message):
    ...
    if sys.version_info >= (3,):
        def ClearField(self, field_name: typing_extensions___Literal[u"cId",u"category",u"icon",u"installPath",u"memo",u"name",u"platform",u"source",u"style",u"type"]) -> None: ...
    else:
        def ClearField(self, field_name: typing_extensions___Literal[b"cId",b"category",b"icon",b"installPath",b"memo",b"name",b"platform",b"source",b"style",b"type"]) -> None: ...
