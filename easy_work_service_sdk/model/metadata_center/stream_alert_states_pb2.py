...
from easy_work_service_sdk.model.metadata_center import stream_alert_rule_pb2 as easy__work__service__sdk_dot_model_dot_metadata__center_dot_stream__alert__rule__pb2
...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  serialized_pb=_b('\n\x19stream_alert_states.proto\x12\x0fmetadata_center\x1a\x43\x65\x61sy_work_service_sdk/model/metadata_center/stream_alert_rule.proto\"d\n\x11StreamAlertStates\x12\x0b\n\x03org\x18\x01 \x01(\x05\x12\x0f\n\x07\x63ommand\x18\x02 \x01(\t\x12\x31\n\x07payload\x18\x03 \x03(\x0b\x32 .metadata_center.StreamAlertRuleBKZIgo.easyops.local/contracts/protorepo-models/easyops/model/metadata_centerb\x06proto3')
  ,
  dependencies=[easy__work__service__sdk_dot_model_dot_metadata__center_dot_stream__alert__rule__pb2.DESCRIPTOR,])
...
_STREAMALERTSTATES.fields_by_name['payload'].message_type = easy__work__service__sdk_dot_model_dot_metadata__center_dot_stream__alert__rule__pb2._STREAMALERTRULE
