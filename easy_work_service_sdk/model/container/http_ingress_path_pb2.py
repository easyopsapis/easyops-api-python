...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  serialized_pb=_b('\n\x17http_ingress_path.proto\x12\tcontainer\x1a;easy_work_service_sdk/model/container/ingress_backend.proto\"K\n\x0fHTTPIngressPath\x12\x0c\n\x04path\x18\x01 \x01(\t\x12*\n\x07\x62\x61\x63kend\x18\x02 \x01(\x0b\x32\x19.container.IngressBackendBEZCgo.easyops.local/contracts/protorepo-models/easyops/model/containerb\x06proto3')
  ,
  dependencies=[easy__work__service__sdk_dot_model_dot_container_dot_ingress__backend__pb2.DESCRIPTOR,])
...
_HTTPINGRESSPATH.fields_by_name['backend'].message_type = easy__work__service__sdk_dot_model_dot_container_dot_ingress__backend__pb2._INGRESSBACKEND
