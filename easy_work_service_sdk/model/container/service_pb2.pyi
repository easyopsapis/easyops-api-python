...
import sys
from easy_work_service_sdk.model.container.loadbalancer_status_pb2 import (
    LoadBalancerStatus as easy_work_service_sdk___model___container___loadbalancer_status_pb2___LoadBalancerStatus,
)

from easy_work_service_sdk.model.container.service_spec_pb2 import (
    ServiceSpec as easy_work_service_sdk___model___container___service_spec_pb2___ServiceSpec,
)
...
class Service(google___protobuf___message___Message):
    ...
    class Status(google___protobuf___message___Message):
        ...
        @property
        def loadBalancer(self) -> easy_work_service_sdk___model___container___loadbalancer_status_pb2___LoadBalancerStatus: ...

        def __init__(self,
            *,
            loadBalancer : typing___Optional[easy_work_service_sdk___model___container___loadbalancer_status_pb2___LoadBalancerStatus] = None,
            ) -> None: ...
        if sys.version_info >= (3,):
            @classmethod
    ...
    @property
    def spec(self) -> easy_work_service_sdk___model___container___service_spec_pb2___ServiceSpec: ...
    ...
    def __init__(self,
        *,
        ...
        spec : typing___Optional[easy_work_service_sdk___model___container___service_spec_pb2___ServiceSpec] = None,
