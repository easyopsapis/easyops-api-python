...
class ListResponse(google___protobuf___message___Message):
    ...
    @property
    def list(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[pipeline_sdk___model___pipeline___provider_pb2___Provider]: ...
    ...
    def __init__(self,
        *,
        ...
        list : typing___Optional[typing___Iterable[pipeline_sdk___model___pipeline___provider_pb2___Provider]] = None,
        ) -> None: ...
    if sys.version_info >= (3,):
        @classmethod
