...
class UpdateRequest(google___protobuf___message___Message):
    ...
    if sys.version_info >= (3,):
        ...
        def ClearField(self, field_name: typing_extensions___Literal[u"project",u"project_id"]) -> None: ...
    else:
        def HasField(self, field_name: typing_extensions___Literal[u"project",b"project"]) -> bool: ...
        def ClearField(self, field_name: typing_extensions___Literal[b"project",b"project_id"]) -> None: ...
...
class UpdateResponseWrapper(google___protobuf___message___Message):
    ...
    @property
    def data(self) -> model___pipeline___project_pb2___Project: ...

    def __init__(self,
        code : typing___Optional[int] = None,
        codeExplain : typing___Optional[typing___Text] = None,
        error : typing___Optional[typing___Text] = None,
        data : typing___Optional[model___pipeline___project_pb2___Project] = None,
        ) -> None: ...
    @classmethod
