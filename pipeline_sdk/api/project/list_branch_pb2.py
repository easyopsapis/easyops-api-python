...
ListBranchResponse = _reflection.GeneratedProtocolMessageType('ListBranchResponse', (_message.Message,), dict(
...
ListBranchResponseWrapper = _reflection.GeneratedProtocolMessageType('ListBranchResponseWrapper', (_message.Message,), dict(
