...
_CREATERESPONSEWRAPPER = _descriptor.Descriptor(
  ...
  full_name='template.CreateResponseWrapper',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='code', full_name='template.CreateResponseWrapper.code', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='codeExplain', full_name='template.CreateResponseWrapper.codeExplain', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='error', full_name='template.CreateResponseWrapper.error', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='data', full_name='template.CreateResponseWrapper.data', index=3,
...
_CREATERESPONSEWRAPPER.fields_by_name['data'].message_type = pipeline__sdk_dot_model_dot_pipeline_dot_template__pb2._TEMPLATE
...
CreateResponseWrapper = _reflection.GeneratedProtocolMessageType('CreateResponseWrapper', (_message.Message,), {
  ...
  # @@protoc_insertion_point(class_scope:template.CreateResponseWrapper)
  })
