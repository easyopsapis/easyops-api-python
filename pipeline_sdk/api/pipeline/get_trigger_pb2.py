...
_GETTRIGGERRESPONSEWRAPPER.fields_by_name['data'].message_type = pipeline__sdk_dot_model_dot_pipeline_dot_trigger__pb2._TRIGGER
...
GetTriggerResponseWrapper = _reflection.GeneratedProtocolMessageType('GetTriggerResponseWrapper', (_message.Message,), {
