...
class CreateRequest(google___protobuf___message___Message):
    ...
    if sys.version_info >= (3,):
        ...
        def ClearField(self, field_name: typing_extensions___Literal[u"pipeline",u"project_id"]) -> None: ...
    else:
        def HasField(self, field_name: typing_extensions___Literal[u"pipeline",b"pipeline"]) -> bool: ...
        def ClearField(self, field_name: typing_extensions___Literal[b"pipeline",b"project_id"]) -> None: ...
