...
class CreateTriggerRequest(google___protobuf___message___Message):
    ...
    @classmethod
    def FromString(cls, s: bytes) -> CreateTriggerRequest: ...
    def MergeFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    if sys.version_info >= (3,):
        def HasField(self, field_name: typing_extensions___Literal[u"trigger"]) -> bool: ...
        def ClearField(self, field_name: typing_extensions___Literal[u"pipeline_id",u"project_id",u"trigger"]) -> None: ...
    else:
        def HasField(self, field_name: typing_extensions___Literal[u"trigger",b"trigger"]) -> bool: ...
        def ClearField(self, field_name: typing_extensions___Literal[b"pipeline_id",b"project_id",b"trigger"]) -> None: ...
...
class CreateTriggerResponseWrapper(google___protobuf___message___Message):
    ...
    @classmethod
    def FromString(cls, s: bytes) -> CreateTriggerResponseWrapper: ...
    def MergeFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    if sys.version_info >= (3,):
