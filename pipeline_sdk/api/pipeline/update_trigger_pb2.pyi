...
class UpdateTriggerRequest(google___protobuf___message___Message):
    ...
    if sys.version_info >= (3,):
        ...
        def ClearField(self, field_name: typing_extensions___Literal[u"id",u"pipeline_id",u"project_id",u"trigger"]) -> None: ...
    else:
        def HasField(self, field_name: typing_extensions___Literal[u"trigger",b"trigger"]) -> bool: ...
        def ClearField(self, field_name: typing_extensions___Literal[b"id",b"pipeline_id",b"project_id",b"trigger"]) -> None: ...
