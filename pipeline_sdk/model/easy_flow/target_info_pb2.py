...
from pipeline_sdk.model.easy_flow import version_info_pb2 as pipeline__sdk_dot_model_dot_easy__flow_dot_version__info__pb2
...
_TARGETINFO_INSTANCEINFO.fields_by_name['versionInfo'].message_type = pipeline__sdk_dot_model_dot_easy__flow_dot_version__info__pb2._VERSIONINFO
_TARGETINFO_INSTANCEINFO.containing_type = _TARGETINFO
_TARGETINFO_OPERATIONINFO.fields_by_name['versionToInfo'].message_type = pipeline__sdk_dot_model_dot_easy__flow_dot_version__info__pb2._VERSIONINFO
_TARGETINFO_OPERATIONINFO.fields_by_name['versionFromInfo'].message_type = pipeline__sdk_dot_model_dot_easy__flow_dot_version__info__pb2._VERSIONINFO
_TARGETINFO_OPERATIONINFO.containing_type = _TARGETINFO
_TARGETINFO.fields_by_name['cluster'].message_type = pipeline__sdk_dot_model_dot_cmdb_dot_cluster__info__pb2._CLUSTERINFO
