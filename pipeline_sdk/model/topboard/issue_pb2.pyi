...
from pipeline_sdk.model.cmdb.user_pb2 import (
    User as pipeline_sdk___model___cmdb___user_pb2___User,
)

from pipeline_sdk.model.topboard.attachment_pb2 import (
    Attachment as pipeline_sdk___model___topboard___attachment_pb2___Attachment,
)

from pipeline_sdk.model.topboard.comment_pb2 import (
    Comment as pipeline_sdk___model___topboard___comment_pb2___Comment,
)

from pipeline_sdk.model.topboard.product_pb2 import (
    Product as pipeline_sdk___model___topboard___product_pb2___Product,
)

from pipeline_sdk.model.topboard.sprint_pb2 import (
    Sprint as pipeline_sdk___model___topboard___sprint_pb2___Sprint,
)
...
class Issue(google___protobuf___message___Message):
    ...
    @property
    def product(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[pipeline_sdk___model___topboard___product_pb2___Product]: ...

    @property
    def sprint(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[pipeline_sdk___model___topboard___sprint_pb2___Sprint]: ...

    @property
    def subscribers(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[pipeline_sdk___model___cmdb___user_pb2___User]: ...

    @property
    def assignee(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[pipeline_sdk___model___cmdb___user_pb2___User]: ...

    @property
    def reporter(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[pipeline_sdk___model___cmdb___user_pb2___User]: ...

    @property
    def attachments(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[pipeline_sdk___model___topboard___attachment_pb2___Attachment]: ...

    @property
    def comments(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[pipeline_sdk___model___topboard___comment_pb2___Comment]: ...

    @property
    def issueFrom(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[Issue.IssueFrom]: ...

    @property
    def tester(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[pipeline_sdk___model___cmdb___user_pb2___User]: ...
    ...
    def __init__(self,
        *,
        ...
        product : typing___Optional[typing___Iterable[pipeline_sdk___model___topboard___product_pb2___Product]] = None,
        sprint : typing___Optional[typing___Iterable[pipeline_sdk___model___topboard___sprint_pb2___Sprint]] = None,
        subscribers : typing___Optional[typing___Iterable[pipeline_sdk___model___cmdb___user_pb2___User]] = None,
        assignee : typing___Optional[typing___Iterable[pipeline_sdk___model___cmdb___user_pb2___User]] = None,
        reporter : typing___Optional[typing___Iterable[pipeline_sdk___model___cmdb___user_pb2___User]] = None,
        attachments : typing___Optional[typing___Iterable[pipeline_sdk___model___topboard___attachment_pb2___Attachment]] = None,
        comments : typing___Optional[typing___Iterable[pipeline_sdk___model___topboard___comment_pb2___Comment]] = None,
        issueFrom : typing___Optional[typing___Iterable[Issue.IssueFrom]] = None,
        tester : typing___Optional[typing___Iterable[pipeline_sdk___model___cmdb___user_pb2___User]] = None,
        name : typing___Optional[typing___Text] = None,
        instanceId : typing___Optional[typing___Text] = None,
