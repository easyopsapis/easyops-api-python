...
from pipeline_sdk.model.container import metadata_pb2 as pipeline__sdk_dot_model_dot_container_dot_metadata__pb2
from pipeline_sdk.model.container import pod_status_pb2 as pipeline__sdk_dot_model_dot_container_dot_pod__status__pb2
...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  serialized_pb=_b('\n\x10pod_detail.proto\x12\tcontainer\x1a+pipeline_sdk/model/container/metadata.proto\x1a-pipeline_sdk/model/container/pod_status.proto\"X\n\tPodDetail\x12%\n\x08metadata\x18\x01 \x01(\x0b\x32\x13.container.Metadata\x12$\n\x06status\x18\x02 \x01(\x0b\x32\x14.container.PodStatusBEZCgo.easyops.local/contracts/protorepo-models/easyops/model/containerb\x06proto3')
  ,
  dependencies=[pipeline__sdk_dot_model_dot_container_dot_metadata__pb2.DESCRIPTOR,pipeline__sdk_dot_model_dot_container_dot_pod__status__pb2.DESCRIPTOR,])
...
_PODDETAIL.fields_by_name['metadata'].message_type = pipeline__sdk_dot_model_dot_container_dot_metadata__pb2._METADATA
_PODDETAIL.fields_by_name['status'].message_type = pipeline__sdk_dot_model_dot_container_dot_pod__status__pb2._PODSTATUS
