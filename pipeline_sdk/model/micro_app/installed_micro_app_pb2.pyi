...
class InstalledMicroApp(google___protobuf___message___Message):
    ...
    if sys.version_info >= (3,):
        ...
        def ClearField(self, field_name: typing_extensions___Literal[u"appId",u"currentVersion",u"homepage",u"icons",u"installStatus",u"internal",u"name",u"private",u"storyboardJson",u"tags"]) -> None: ...
    else:
        def HasField(self, field_name: typing_extensions___Literal[u"icons",b"icons"]) -> bool: ...
        def ClearField(self, field_name: typing_extensions___Literal[b"appId",b"currentVersion",b"homepage",b"icons",b"installStatus",b"internal",b"name",b"private",b"storyboardJson",b"tags"]) -> None: ...
