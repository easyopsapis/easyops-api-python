...
class AppStoreMicroApp(google___protobuf___message___Message):
    ...
    if sys.version_info >= (3,):
        def ClearField(self, field_name: typing_extensions___Literal[u"icon",u"id",u"intro",u"name",u"newFeature",u"preview"]) -> None: ...
    else:
        def ClearField(self, field_name: typing_extensions___Literal[b"icon",b"id",b"intro",b"name",b"newFeature",b"preview"]) -> None: ...
