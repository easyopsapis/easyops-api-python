...
from pipeline_sdk.model.cmdb.object_attr_pb2 import (
    ObjectAttr as pipeline_sdk___model___cmdb___object_attr_pb2___ObjectAttr,
)

from pipeline_sdk.model.cmdb.object_index_pb2 import (
    ObjectIndex as pipeline_sdk___model___cmdb___object_index_pb2___ObjectIndex,
)

from pipeline_sdk.model.cmdb.object_relation_group_pb2 import (
    ObjectRelationGroup as pipeline_sdk___model___cmdb___object_relation_group_pb2___ObjectRelationGroup,
)

from pipeline_sdk.model.cmdb.object_relation_pb2 import (
    ObjectRelation as pipeline_sdk___model___cmdb___object_relation_pb2___ObjectRelation,
)

from pipeline_sdk.model.cmdb.object_view_pb2 import (
    ObjectView as pipeline_sdk___model___cmdb___object_view_pb2___ObjectView,
)
...
class CmdbObject(google___protobuf___message___Message):
    ...
    @property
    def attrList(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[pipeline_sdk___model___cmdb___object_attr_pb2___ObjectAttr]: ...

    @property
    def relation_list(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[pipeline_sdk___model___cmdb___object_relation_pb2___ObjectRelation]: ...

    @property
    def relation_groups(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[pipeline_sdk___model___cmdb___object_relation_group_pb2___ObjectRelationGroup]: ...

    @property
    def indexList(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[pipeline_sdk___model___cmdb___object_index_pb2___ObjectIndex]: ...

    @property
    def view(self) -> pipeline_sdk___model___cmdb___object_view_pb2___ObjectView: ...

    def __init__(self,
        *,
        attrList : typing___Optional[typing___Iterable[pipeline_sdk___model___cmdb___object_attr_pb2___ObjectAttr]] = None,
        relation_list : typing___Optional[typing___Iterable[pipeline_sdk___model___cmdb___object_relation_pb2___ObjectRelation]] = None,
        relation_groups : typing___Optional[typing___Iterable[pipeline_sdk___model___cmdb___object_relation_group_pb2___ObjectRelationGroup]] = None,
        indexList : typing___Optional[typing___Iterable[pipeline_sdk___model___cmdb___object_index_pb2___ObjectIndex]] = None,
        name : typing___Optional[typing___Text] = None,
        objectId : typing___Optional[typing___Text] = None,
        memo : typing___Optional[typing___Text] = None,
        view : typing___Optional[pipeline_sdk___model___cmdb___object_view_pb2___ObjectView] = None,
