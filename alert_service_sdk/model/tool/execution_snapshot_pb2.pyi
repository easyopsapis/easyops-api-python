...
from alert_service_sdk.model.tool.extra_info_pb2 import (
    ExtraInfo as alert_service_sdk___model___tool___extra_info_pb2___ExtraInfo,
)
...
class ExecutionSnapshot(google___protobuf___message___Message):
    ...
    @property
    def extraInfo(self) -> alert_service_sdk___model___tool___extra_info_pb2___ExtraInfo: ...
    ...
    def __init__(self,
        *,
        ...
        extraInfo : typing___Optional[alert_service_sdk___model___tool___extra_info_pb2___ExtraInfo] = None,
