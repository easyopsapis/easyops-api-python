...
class GetResponse(google___protobuf___message___Message):
    ...
    @property
    def data(self) -> easy_flow_sdk___model___easy_flow___deploy_ret_pb2___DeployRet: ...

    def __init__(self,
        *,
        code : typing___Optional[builtin___int] = None,
        msg : typing___Optional[typing___Text] = None,
        data : typing___Optional[easy_flow_sdk___model___easy_flow___deploy_ret_pb2___DeployRet] = None,
        ) -> None: ...
    if sys.version_info >= (3,):
        @classmethod
