...
from model.easy_flow.deploy_ret_pb2 import (
    DeployRet as model___easy_flow___deploy_ret_pb2___DeployRet,
)
...
class ListRequest(google___protobuf___message___Message):
    taskIdList = ... # type: typing___Text

    def __init__(self,
        taskIdList : typing___Optional[typing___Text] = None,
        ) -> None: ...
    @classmethod
    ...
    if sys.version_info >= (3,):
        def ClearField(self, field_name: typing_extensions___Literal[u"taskIdList"]) -> None: ...
    else:
        def ClearField(self, field_name: typing_extensions___Literal[b"taskIdList"]) -> None: ...
...
class ListResponse(google___protobuf___message___Message):
    ...
    @property
    def data(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[model___easy_flow___deploy_ret_pb2___DeployRet]: ...

    def __init__(self,
        code : typing___Optional[int] = None,
        msg : typing___Optional[typing___Text] = None,
        data : typing___Optional[typing___Iterable[model___easy_flow___deploy_ret_pb2___DeployRet]] = None,
        ) -> None: ...
    @classmethod
