...
import sys
from easy_flow_sdk.model.easy_flow.deploy_ret_pb2 import (
    DeployRet as easy_flow_sdk___model___easy_flow___deploy_ret_pb2___DeployRet,
)
...
class ListRequest(google___protobuf___message___Message):
    ...
    def ClearField(self, field_name: typing_extensions___Literal[u"taskIdList",b"taskIdList"]) -> None: ...
...
class ListResponse(google___protobuf___message___Message):
    ...
    @property
    def data(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[easy_flow_sdk___model___easy_flow___deploy_ret_pb2___DeployRet]: ...

    def __init__(self,
        *,
        code : typing___Optional[builtin___int] = None,
        msg : typing___Optional[typing___Text] = None,
        data : typing___Optional[typing___Iterable[easy_flow_sdk___model___easy_flow___deploy_ret_pb2___DeployRet]] = None,
        ) -> None: ...
    if sys.version_info >= (3,):
        @classmethod
