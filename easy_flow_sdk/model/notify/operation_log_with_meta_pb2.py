...
_OPERATIONLOGWITHMETA.fields_by_name['data'].message_type = model_dot_notify_dot_operation__log__pb2._OPERATIONLOG
DESCRIPTOR.message_types_by_name['OperationLogWithMeta'] = _OPERATIONLOGWITHMETA
_sym_db.RegisterFileDescriptor(DESCRIPTOR)

OperationLogWithMeta = _reflection.GeneratedProtocolMessageType('OperationLogWithMeta', (_message.Message,), dict(
