...
from database_delivery_sdk.model.msgsender import message_receiver_pb2 as database__delivery__sdk_dot_model_dot_msgsender_dot_message__receiver__pb2
from database_delivery_sdk.model.msgsender import messsage_data_pb2 as database__delivery__sdk_dot_model_dot_msgsender_dot_messsage__data__pb2
...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  serialized_pb=_b('\n\x1fsend_message_request_data.proto\x12\tmsgsender\x1a<database_delivery_sdk/model/msgsender/message_receiver.proto\x1a\x39\x64\x61tabase_delivery_sdk/model/msgsender/messsage_data.proto\"q\n\x16SendMessageRequestData\x12-\n\treceivers\x18\x01 \x03(\x0b\x32\x1a.msgsender.MessageReceiver\x12(\n\x08msg_data\x18\x02 \x01(\x0b\x32\x16.msgsender.MessageDataBEZCgo.easyops.local/contracts/protorepo-models/easyops/model/msgsenderb\x06proto3')
  ,
  dependencies=[database__delivery__sdk_dot_model_dot_msgsender_dot_message__receiver__pb2.DESCRIPTOR,database__delivery__sdk_dot_model_dot_msgsender_dot_messsage__data__pb2.DESCRIPTOR,])
...
_SENDMESSAGEREQUESTDATA.fields_by_name['receivers'].message_type = database__delivery__sdk_dot_model_dot_msgsender_dot_message__receiver__pb2._MESSAGERECEIVER
_SENDMESSAGEREQUESTDATA.fields_by_name['msg_data'].message_type = database__delivery__sdk_dot_model_dot_msgsender_dot_messsage__data__pb2._MESSAGEDATA
