...
import sys
from database_delivery_sdk.model.cmdb.object_attr_value_pb2 import (
    ObjectAttrValue as database_delivery_sdk___model___cmdb___object_attr_value_pb2___ObjectAttrValue,
)
...
class ObjectImport(google___protobuf___message___Message):
    ...
    class AttrList(google___protobuf___message___Message):
        ...
        @property
        def value(self) -> database_delivery_sdk___model___cmdb___object_attr_value_pb2___ObjectAttrValue: ...
        ...
        def __init__(self,
            *,
            ...
            value : typing___Optional[database_delivery_sdk___model___cmdb___object_attr_value_pb2___ObjectAttrValue] = None,
            ) -> None: ...
        if sys.version_info >= (3,):
            @classmethod
