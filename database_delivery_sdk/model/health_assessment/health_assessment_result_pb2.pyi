...
from database_delivery_sdk.model.health_assessment.health_assessment_related_resource_event_score_pb2 import (
    HealthAssessmentRelatedResourceEventScore as database_delivery_sdk___model___health_assessment___health_assessment_related_resource_event_score_pb2___HealthAssessmentRelatedResourceEventScore,
)
...
class HealthAssessmentResult(google___protobuf___message___Message):
    ...
    @property
    def relatedResourceEventScores(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[database_delivery_sdk___model___health_assessment___health_assessment_related_resource_event_score_pb2___HealthAssessmentRelatedResourceEventScore]: ...
    ...
    def __init__(self,
        *,
        ...
        relatedResourceEventScores : typing___Optional[typing___Iterable[database_delivery_sdk___model___health_assessment___health_assessment_related_resource_event_score_pb2___HealthAssessmentRelatedResourceEventScore]] = None,
