...
_CHECKTASKCALLBACKREQUEST.fields_by_name['command'].message_type = model_dot_easy__command_dot_task__detail__pb2._TASKDETAIL
...
CheckTaskCallbackRequest = _reflection.GeneratedProtocolMessageType('CheckTaskCallbackRequest', (_message.Message,), dict(
...
CheckTaskCallbackResponse = _reflection.GeneratedProtocolMessageType('CheckTaskCallbackResponse', (_message.Message,), dict(
...
CheckTaskCallbackResponseWrapper = _reflection.GeneratedProtocolMessageType('CheckTaskCallbackResponseWrapper', (_message.Message,), dict(
