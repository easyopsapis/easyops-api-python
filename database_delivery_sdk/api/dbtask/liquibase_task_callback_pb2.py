...
_LIQUIBASETASKCALLBACKREQUEST.fields_by_name['command'].message_type = database__delivery__sdk_dot_model_dot_easy__command_dot_task__detail__pb2._TASKDETAIL
...
LiquibaseTaskCallbackRequest = _reflection.GeneratedProtocolMessageType('LiquibaseTaskCallbackRequest', (_message.Message,), {
...
LiquibaseTaskCallbackResponse = _reflection.GeneratedProtocolMessageType('LiquibaseTaskCallbackResponse', (_message.Message,), {
...
LiquibaseTaskCallbackResponseWrapper = _reflection.GeneratedProtocolMessageType('LiquibaseTaskCallbackResponseWrapper', (_message.Message,), {
