...
class UpdateSQLPackageRequest(google___protobuf___message___Message):
    class UpdateSqlpkg(google___protobuf___message___Message):
        ...
        @classmethod
        def FromString(cls, s: bytes) -> UpdateSQLPackageRequest.UpdateSqlpkg: ...
        def MergeFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
        def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
        if sys.version_info >= (3,):
            def ClearField(self, field_name: typing_extensions___Literal[u"appPackageId",u"memo",u"name"]) -> None: ...
        else:
            def ClearField(self, field_name: typing_extensions___Literal[b"appPackageId",b"memo",b"name"]) -> None: ...
    ...
    @classmethod
    def FromString(cls, s: bytes) -> UpdateSQLPackageRequest: ...
    def MergeFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    if sys.version_info >= (3,):
        def HasField(self, field_name: typing_extensions___Literal[u"updateSqlpkg"]) -> bool: ...
        def ClearField(self, field_name: typing_extensions___Literal[u"pkgId",u"updateSqlpkg"]) -> None: ...
    else:
        def HasField(self, field_name: typing_extensions___Literal[u"updateSqlpkg",b"updateSqlpkg"]) -> bool: ...
        def ClearField(self, field_name: typing_extensions___Literal[b"pkgId",b"updateSqlpkg"]) -> None: ...
...
class UpdateSQLPackageResponse(google___protobuf___message___Message):
    ...
    @classmethod
    def FromString(cls, s: bytes) -> UpdateSQLPackageResponse: ...
    def MergeFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    if sys.version_info >= (3,):
...
class UpdateSQLPackageResponseWrapper(google___protobuf___message___Message):
    ...
    @classmethod
    def FromString(cls, s: bytes) -> UpdateSQLPackageResponseWrapper: ...
    def MergeFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    if sys.version_info >= (3,):
