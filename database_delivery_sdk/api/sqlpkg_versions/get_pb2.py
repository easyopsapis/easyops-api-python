...
_GETSQLPACKAGEVERSIONRESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='versionName', full_name='sqlpkg_versions.GetSQLPackageVersionResponse.versionName', index=4,
      number=5, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='memo', full_name='sqlpkg_versions.GetSQLPackageVersionResponse.memo', index=5,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='creator', full_name='sqlpkg_versions.GetSQLPackageVersionResponse.creator', index=6,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='ctime', full_name='sqlpkg_versions.GetSQLPackageVersionResponse.ctime', index=7,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='mtime', full_name='sqlpkg_versions.GetSQLPackageVersionResponse.mtime', index=8,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='versionType', full_name='sqlpkg_versions.GetSQLPackageVersionResponse.versionType', index=9,
...
GetSQLPackageVersionRequest = _reflection.GeneratedProtocolMessageType('GetSQLPackageVersionRequest', (_message.Message,), {
...
GetSQLPackageVersionResponse = _reflection.GeneratedProtocolMessageType('GetSQLPackageVersionResponse', (_message.Message,), {
...
GetSQLPackageVersionResponseWrapper = _reflection.GeneratedProtocolMessageType('GetSQLPackageVersionResponseWrapper', (_message.Message,), {
