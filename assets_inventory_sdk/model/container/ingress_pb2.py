...
from assets_inventory_sdk.model.container import ingress_backend_pb2 as assets__inventory__sdk_dot_model_dot_container_dot_ingress__backend__pb2
from assets_inventory_sdk.model.container import ingress_rule_pb2 as assets__inventory__sdk_dot_model_dot_container_dot_ingress__rule__pb2
from assets_inventory_sdk.model.container import ingress_tls_pb2 as assets__inventory__sdk_dot_model_dot_container_dot_ingress__tls__pb2
...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  serialized_pb=_b('\n\ringress.proto\x12\tcontainer\x1a:assets_inventory_sdk/model/container/ingress_backend.proto\x1a\x37\x61ssets_inventory_sdk/model/container/ingress_rule.proto\x1a\x36\x61ssets_inventory_sdk/model/container/ingress_tls.proto\x1a\x1cgoogle/protobuf/struct.proto\"\xd4\x02\n\x07Ingress\x12\x12\n\ninstanceId\x18\x01 \x01(\t\x12\x0c\n\x04kind\x18\x02 \x01(\t\x12\x11\n\tnamespace\x18\x03 \x01(\t\x12\x14\n\x0cresourceName\x18\x04 \x01(\t\x12\x13\n\x0b\x64isplayName\x18\x05 \x01(\t\x12\x13\n\x0b\x64\x65scription\x18\x06 \x01(\t\x12,\n\x0b\x61nnotations\x18\x07 \x01(\x0b\x32\x17.google.protobuf.Struct\x12\x0f\n\x07\x61\x64\x64ress\x18\x08 \x03(\t\x12*\n\x07\x62\x61\x63kend\x18\t \x01(\x0b\x32\x19.container.IngressBackend\x12%\n\x05rules\x18\n \x03(\x0b\x32\x16.container.IngressRule\x12\"\n\x03tls\x18\x0b \x03(\x0b\x32\x15.container.IngressTLS\x12\r\n\x05\x63time\x18\x0c \x01(\t\x12\x0f\n\x07\x63reator\x18\r \x01(\tBEZCgo.easyops.local/contracts/protorepo-models/easyops/model/containerb\x06proto3')
  ,
  dependencies=[assets__inventory__sdk_dot_model_dot_container_dot_ingress__backend__pb2.DESCRIPTOR,assets__inventory__sdk_dot_model_dot_container_dot_ingress__rule__pb2.DESCRIPTOR,assets__inventory__sdk_dot_model_dot_container_dot_ingress__tls__pb2.DESCRIPTOR,google_dot_protobuf_dot_struct__pb2.DESCRIPTOR,])
...
_INGRESS.fields_by_name['backend'].message_type = assets__inventory__sdk_dot_model_dot_container_dot_ingress__backend__pb2._INGRESSBACKEND
_INGRESS.fields_by_name['rules'].message_type = assets__inventory__sdk_dot_model_dot_container_dot_ingress__rule__pb2._INGRESSRULE
_INGRESS.fields_by_name['tls'].message_type = assets__inventory__sdk_dot_model_dot_container_dot_ingress__tls__pb2._INGRESSTLS
