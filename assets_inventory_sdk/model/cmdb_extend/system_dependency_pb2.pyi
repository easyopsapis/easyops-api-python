...
import sys
from assets_inventory_sdk.model.cmdb_extend.subsystem_dependency_pb2 import (
    SubsystemDependency as assets_inventory_sdk___model___cmdb_extend___subsystem_dependency_pb2___SubsystemDependency,
)
...
class SystemDependency(google___protobuf___message___Message):
    ...
    @property
    def subsystems(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[assets_inventory_sdk___model___cmdb_extend___subsystem_dependency_pb2___SubsystemDependency]: ...
    ...
    def __init__(self,
        *,
        ...
        subsystems : typing___Optional[typing___Iterable[assets_inventory_sdk___model___cmdb_extend___subsystem_dependency_pb2___SubsystemDependency]] = None,
        ) -> None: ...
    if sys.version_info >= (3,):
        @classmethod
