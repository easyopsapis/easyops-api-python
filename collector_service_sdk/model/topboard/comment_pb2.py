...
_COMMENT.fields_by_name['issue'].message_type = collector__service__sdk_dot_model_dot_topboard_dot_issue__basic__pb2._ISSUEBASIC
_COMMENT.fields_by_name['author'].message_type = collector__service__sdk_dot_model_dot_cmdb_dot_user__pb2._USER
