...
import sys
from collector_service_sdk.model.flowable.process_variable_pb2 import (
    FlowableProcessVariable as collector_service_sdk___model___flowable___process_variable_pb2___FlowableProcessVariable,
)
...
class FlowableProcessInstance(google___protobuf___message___Message):
    ...
    @property
    def variables(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[collector_service_sdk___model___flowable___process_variable_pb2___FlowableProcessVariable]: ...
    ...
    def __init__(self,
        *,
        ...
        variables : typing___Optional[typing___Iterable[collector_service_sdk___model___flowable___process_variable_pb2___FlowableProcessVariable]] = None,
        ) -> None: ...
    if sys.version_info >= (3,):
        @classmethod
