...
import topology_sdk.api.org.org_register_pb2
...
class OrgClient(object):
    ...
    def listen_org_register(self, request, org, user, timeout=10):
        # type: (topology_sdk.api.org.org_register_pb2.ListenOrgRegisterRequest, int, str, int) -> google.protobuf.empty_pb2.Empty
        """
        监听ORG创建事件
        ...
        if self._service_name != "":
            ...
            route_name = "easyops.api.topology.org.ListenOrgRegister"
