...
class CreateContainerRequest(google___protobuf___message___Message):
    class Style(google___protobuf___message___Message):
        ...
        @classmethod
        def FromString(cls, s: bytes) -> CreateContainerRequest.Style: ...
    ...
    @classmethod
    def FromString(cls, s: bytes) -> CreateContainerRequest: ...
    def MergeFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    if sys.version_info >= (3,):
        def HasField(self, field_name: typing_extensions___Literal[u"property",u"style"]) -> bool: ...
        def ClearField(self, field_name: typing_extensions___Literal[u"collapse",u"dataSource",u"name",u"property",u"style"]) -> None: ...
    else:
        def HasField(self, field_name: typing_extensions___Literal[u"property",b"property",u"style",b"style"]) -> bool: ...
        def ClearField(self, field_name: typing_extensions___Literal[b"collapse",b"dataSource",b"name",b"property",b"style"]) -> None: ...
...
class CreateContainerResponse(google___protobuf___message___Message):
    ...
    @classmethod
    def FromString(cls, s: bytes) -> CreateContainerResponse: ...
    def MergeFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    if sys.version_info >= (3,):
...
class CreateContainerResponseWrapper(google___protobuf___message___Message):
    ...
    @classmethod
    def FromString(cls, s: bytes) -> CreateContainerResponseWrapper: ...
    def MergeFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    if sys.version_info >= (3,):
