...
_CREATECONTAINERREQUEST.fields_by_name['property'].message_type = model_dot_topology_dot_property__pb2._PROPERTY
...
CreateContainerResponseWrapper = _reflection.GeneratedProtocolMessageType('CreateContainerResponseWrapper', (_message.Message,), dict(
