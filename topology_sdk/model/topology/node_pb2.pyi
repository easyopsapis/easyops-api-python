...
from topology_sdk.model.topology.nodeStyle_pb2 import (
    NodeStyle as topology_sdk___model___topology___nodeStyle_pb2___NodeStyle,
)
...
class Node(google___protobuf___message___Message):
    ...
    @property
    def style(self) -> topology_sdk___model___topology___nodeStyle_pb2___NodeStyle: ...
    ...
    def __init__(self,
        *,
        ...
        style : typing___Optional[topology_sdk___model___topology___nodeStyle_pb2___NodeStyle] = None,
        ) -> None: ...
    if sys.version_info >= (3,):
        @classmethod
