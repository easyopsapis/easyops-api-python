...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  serialized_pb=_b('\n\x13messsage_data.proto\x12\tmsgsender\"R\n\x0bMessageData\x12\x0f\n\x07\x63ontent\x18\x01 \x01(\t\x12\x0f\n\x07subject\x18\x02 \x01(\t\x12\x0f\n\x07\x63\x63_addr\x18\x03 \x01(\t\x12\x10\n\x08msg_type\x18\x04 \x01(\tBEZCgo.easyops.local/contracts/protorepo-models/easyops/model/msgsenderb\x06proto3')
)
...
_MESSAGEDATA = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='msg_type', full_name='msgsender.MessageData.msg_type', index=3,
