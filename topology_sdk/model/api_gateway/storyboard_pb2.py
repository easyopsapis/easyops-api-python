...
from topology_sdk.model.micro_app import installed_micro_app_bootstrap_pb2 as topology__sdk_dot_model_dot_micro__app_dot_installed__micro__app__bootstrap__pb2
...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  serialized_pb=_b('\n\x10storyboard.proto\x12\x0b\x61pi_gateway\x1a@topology_sdk/model/micro_app/installed_micro_app_bootstrap.proto\x1a\x1cgoogle/protobuf/struct.proto\"\xa4\x01\n\nStoryBoard\x12\x32\n\x03\x61pp\x18\x01 \x01(\x0b\x32%.micro_app.InstalledMicroAppBootstrap\x12\x12\n\ndependsAll\x18\x02 \x01(\x08\x12\'\n\x06routes\x18\x03 \x03(\x0b\x32\x17.google.protobuf.Struct\x12%\n\x04meta\x18\x04 \x01(\x0b\x32\x17.google.protobuf.StructBGZEgo.easyops.local/contracts/protorepo-models/easyops/model/api_gatewayb\x06proto3')
  ,
  dependencies=[topology__sdk_dot_model_dot_micro__app_dot_installed__micro__app__bootstrap__pb2.DESCRIPTOR,google_dot_protobuf_dot_struct__pb2.DESCRIPTOR,])
...
_STORYBOARD.fields_by_name['app'].message_type = topology__sdk_dot_model_dot_micro__app_dot_installed__micro__app__bootstrap__pb2._INSTALLEDMICROAPPBOOTSTRAP
