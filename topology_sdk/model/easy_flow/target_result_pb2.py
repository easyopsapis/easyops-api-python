...
from model.easy_flow import deploy_package_result_pb2 as model_dot_easy__flow_dot_deploy__package__result__pb2
...
_TARGETRESULT.fields_by_name['cluster'].message_type = model_dot_cmdb_dot_cluster__info__pb2._CLUSTERINFO
_TARGETRESULT.fields_by_name['packageStatus'].message_type = model_dot_easy__flow_dot_deploy__package__result__pb2._DEPLOYPACKAGERESULT
DESCRIPTOR.message_types_by_name['TargetResult'] = _TARGETRESULT
_sym_db.RegisterFileDescriptor(DESCRIPTOR)

TargetResult = _reflection.GeneratedProtocolMessageType('TargetResult', (_message.Message,), dict(
