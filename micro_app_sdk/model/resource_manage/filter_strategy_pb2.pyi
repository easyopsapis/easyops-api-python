...
from micro_app_sdk.model.console.cmdb_query_strategy_pb2 import (
    CmdbQueryStrategy as micro_app_sdk___model___console___cmdb_query_strategy_pb2___CmdbQueryStrategy,
)

from micro_app_sdk.model.resource_manage.filter_condition_group_pb2 import (
    FilterConditionGroup as micro_app_sdk___model___resource_manage___filter_condition_group_pb2___FilterConditionGroup,
)
...
class FilterStrategy(google___protobuf___message___Message):
    ...
    @property
    def query(self) -> micro_app_sdk___model___console___cmdb_query_strategy_pb2___CmdbQueryStrategy: ...

    @property
    def filter(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[micro_app_sdk___model___resource_manage___filter_condition_group_pb2___FilterConditionGroup]: ...
    ...
    def __init__(self,
        *,
        ...
        query : typing___Optional[micro_app_sdk___model___console___cmdb_query_strategy_pb2___CmdbQueryStrategy] = None,
        filter : typing___Optional[typing___Iterable[micro_app_sdk___model___resource_manage___filter_condition_group_pb2___FilterConditionGroup]] = None,
