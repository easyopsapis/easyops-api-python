...
class ListMicroAppResponse(google___protobuf___message___Message):
    ...
    @property
    def list(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[model___micro_app___installed_micro_app_pb2___InstalledMicroApp]: ...

    def __init__(self,
        page : typing___Optional[int] = None,
        page_size : typing___Optional[int] = None,
        total : typing___Optional[int] = None,
        list : typing___Optional[typing___Iterable[model___micro_app___installed_micro_app_pb2___InstalledMicroApp]] = None,
        ) -> None: ...
    @classmethod
