...
import get_permission_role_list_pb2

import get_user_role_pb2
...
class RoleClient(object):
    ...
    def get_permission_role_list(self, request, org, user, timeout=10):
        ...
        :return: get_permission_role_list_pb2.GetPermissionRoleListResponse
        """
        ...
        rsp = get_permission_role_list_pb2.GetPermissionRoleListResponse()
    ...
    def get_user_role(self, request, org, user, timeout=10):
        ...
        :param user: 调用api使用的用户名
        :param timeout: 调用超时时间，单位秒
        :return: get_user_role_pb2.GetUserRoleResponse
        """
        headers = {"org": org, "user": user}
        route_name = ""
        server_ip = self._server_ip
        ...
        rsp = get_user_role_pb2.GetUserRoleResponse()
