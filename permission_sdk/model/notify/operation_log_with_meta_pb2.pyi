...
from permission_sdk.model.notify.operation_log_pb2 import (
    OperationLog as permission_sdk___model___notify___operation_log_pb2___OperationLog,
)
...
class OperationLogWithMeta(google___protobuf___message___Message):
    ...
    @property
    def data(self) -> permission_sdk___model___notify___operation_log_pb2___OperationLog: ...

    def __init__(self,
        *,
        system : typing___Optional[typing___Text] = None,
        topic : typing___Optional[typing___Text] = None,
        data : typing___Optional[permission_sdk___model___notify___operation_log_pb2___OperationLog] = None,
        ) -> None: ...
    if sys.version_info >= (3,):
        @classmethod
