...
from permission_sdk.model.topology.nodeStyle_pb2 import (
    NodeStyle as permission_sdk___model___topology___nodeStyle_pb2___NodeStyle,
)

from permission_sdk.model.topology.property_pb2 import (
    Property as permission_sdk___model___topology___property_pb2___Property,
)
...
class Node(google___protobuf___message___Message):
    ...
    @property
    def property(self) -> permission_sdk___model___topology___property_pb2___Property: ...

    @property
    def style(self) -> permission_sdk___model___topology___nodeStyle_pb2___NodeStyle: ...
    ...
    def __init__(self,
        *,
        ...
        property : typing___Optional[permission_sdk___model___topology___property_pb2___Property] = None,
        collapse : typing___Optional[builtin___bool] = None,
        style : typing___Optional[permission_sdk___model___topology___nodeStyle_pb2___NodeStyle] = None,
        ) -> None: ...
    if sys.version_info >= (3,):
        @classmethod
