...
from permission_sdk.model.msgsender import message_receiver_pb2 as permission__sdk_dot_model_dot_msgsender_dot_message__receiver__pb2
from permission_sdk.model.msgsender import messsage_data_pb2 as permission__sdk_dot_model_dot_msgsender_dot_messsage__data__pb2
...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  serialized_pb=_b('\n\x1fsend_message_request_data.proto\x12\tmsgsender\x1a\x35permission_sdk/model/msgsender/message_receiver.proto\x1a\x32permission_sdk/model/msgsender/messsage_data.proto\"q\n\x16SendMessageRequestData\x12-\n\treceivers\x18\x01 \x03(\x0b\x32\x1a.msgsender.MessageReceiver\x12(\n\x08msg_data\x18\x02 \x01(\x0b\x32\x16.msgsender.MessageDataBEZCgo.easyops.local/contracts/protorepo-models/easyops/model/msgsenderb\x06proto3')
  ,
  dependencies=[permission__sdk_dot_model_dot_msgsender_dot_message__receiver__pb2.DESCRIPTOR,permission__sdk_dot_model_dot_msgsender_dot_messsage__data__pb2.DESCRIPTOR,])
...
_SENDMESSAGEREQUESTDATA.fields_by_name['receivers'].message_type = permission__sdk_dot_model_dot_msgsender_dot_message__receiver__pb2._MESSAGERECEIVER
_SENDMESSAGEREQUESTDATA.fields_by_name['msg_data'].message_type = permission__sdk_dot_model_dot_msgsender_dot_messsage__data__pb2._MESSAGEDATA
