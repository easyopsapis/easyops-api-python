...
from permission_sdk.model.container.http_ingress_path_pb2 import (
    HTTPIngressPath as permission_sdk___model___container___http_ingress_path_pb2___HTTPIngressPath,
)
...
class IngressRule(google___protobuf___message___Message):
    ...
    class Http(google___protobuf___message___Message):
        ...
        @property
        def paths(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[permission_sdk___model___container___http_ingress_path_pb2___HTTPIngressPath]: ...

        def __init__(self,
            *,
            paths : typing___Optional[typing___Iterable[permission_sdk___model___container___http_ingress_path_pb2___HTTPIngressPath]] = None,
            ) -> None: ...
        if sys.version_info >= (3,):
            @classmethod
