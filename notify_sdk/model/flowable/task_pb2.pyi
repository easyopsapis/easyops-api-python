...
from notify_sdk.model.flowable.process_variable_pb2 import (
    FlowableProcessVariable as notify_sdk___model___flowable___process_variable_pb2___FlowableProcessVariable,
)
...
class FlowableTask(google___protobuf___message___Message):
    ...
    @property
    def variables(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[notify_sdk___model___flowable___process_variable_pb2___FlowableProcessVariable]: ...
    ...
    def __init__(self,
        *,
        ...
        variables : typing___Optional[typing___Iterable[notify_sdk___model___flowable___process_variable_pb2___FlowableProcessVariable]] = None,
        ) -> None: ...
    if sys.version_info >= (3,):
        @classmethod
