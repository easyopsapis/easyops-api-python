...
from notify_sdk.model.inspection.condition_pb2 import (
    InspectionCondition as notify_sdk___model___inspection___condition_pb2___InspectionCondition,
)
...
class InspectionVal(google___protobuf___message___Message):
    ...
    @property
    def conditions(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[notify_sdk___model___inspection___condition_pb2___InspectionCondition]: ...
    ...
    def __init__(self,
        *,
        ...
        conditions : typing___Optional[typing___Iterable[notify_sdk___model___inspection___condition_pb2___InspectionCondition]] = None,
        ) -> None: ...
    if sys.version_info >= (3,):
        @classmethod
