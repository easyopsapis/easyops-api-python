...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  serialized_pb=_b('\n\x0b\x62uild.proto\x12\x08pipeline\x1a\x1dmodel/pipeline/git_meta.proto\x1a!model/pipeline/build_status.proto\"\xa5\x01\n\x05\x42uild\x12\n\n\x02id\x18\x01 \x01(\t\x12#\n\x08git_meta\x18\x02 \x01(\x0b\x32\x11.pipeline.GitMeta\x12\x0e\n\x06sender\x18\x03 \x01(\t\x12\x0f\n\x07\x63reated\x18\x04 \x01(\x05\x12\x13\n\x0byaml_string\x18\x05 \x01(\t\x12%\n\x06status\x18\x06 \x01(\x0b\x32\x15.pipeline.BuildStatus\x12\x0e\n\x06number\x18\x07 \x01(\tBDZBgo.easyops.local/contracts/protorepo-models/easyops/model/pipelineb\x06proto3')
  ,
  dependencies=[model_dot_pipeline_dot_git__meta__pb2.DESCRIPTOR,model_dot_pipeline_dot_build__status__pb2.DESCRIPTOR,])
...
_BUILD.fields_by_name['git_meta'].message_type = model_dot_pipeline_dot_git__meta__pb2._GITMETA
