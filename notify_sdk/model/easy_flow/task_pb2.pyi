...
from notify_sdk.model.easy_flow.deploy_target_pb2 import (
    DeployTarget as notify_sdk___model___easy_flow___deploy_target_pb2___DeployTarget,
)

from notify_sdk.model.easy_flow.package_info_pb2 import (
    PackageInfo as notify_sdk___model___easy_flow___package_info_pb2___PackageInfo,
)

from notify_sdk.model.easy_flow.target_info_pb2 import (
    TargetInfo as notify_sdk___model___easy_flow___target_info_pb2___TargetInfo,
)
...
class Task(google___protobuf___message___Message):
    ...
    class Batches(google___protobuf___message___Message):
        ...
        @property
        def targets(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[notify_sdk___model___easy_flow___deploy_target_pb2___DeployTarget]: ...

        def __init__(self,
            *,
            targets : typing___Optional[typing___Iterable[notify_sdk___model___easy_flow___deploy_target_pb2___DeployTarget]] = None,
            ) -> None: ...
        if sys.version_info >= (3,):
            @classmethod
    ...
    @property
    def targetList(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[notify_sdk___model___easy_flow___target_info_pb2___TargetInfo]: ...

    @property
    def packageList(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[notify_sdk___model___easy_flow___package_info_pb2___PackageInfo]: ...
    ...
    def __init__(self,
        *,
        ...
        targetList : typing___Optional[typing___Iterable[notify_sdk___model___easy_flow___target_info_pb2___TargetInfo]] = None,
        packageList : typing___Optional[typing___Iterable[notify_sdk___model___easy_flow___package_info_pb2___PackageInfo]] = None,
