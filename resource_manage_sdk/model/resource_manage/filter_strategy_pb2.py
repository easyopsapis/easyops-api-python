...
_FILTERSTRATEGY.fields_by_name['query'].message_type = resource__manage__sdk_dot_model_dot_console_dot_cmdb__query__strategy__pb2._CMDBQUERYSTRATEGY
_FILTERSTRATEGY.fields_by_name['filter'].message_type = resource__manage__sdk_dot_model_dot_resource__manage_dot_filter__condition__group__pb2._FILTERCONDITIONGROUP
