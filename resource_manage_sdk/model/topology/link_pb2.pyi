...
from resource_manage_sdk.model.topology.linkStyle_pb2 import (
    LinkStyle as resource_manage_sdk___model___topology___linkStyle_pb2___LinkStyle,
)
...
class Link(google___protobuf___message___Message):
    ...
    @property
    def style(self) -> resource_manage_sdk___model___topology___linkStyle_pb2___LinkStyle: ...

    def __init__(self,
        *,
        source : typing___Optional[typing___Text] = None,
        target : typing___Optional[typing___Text] = None,
        style : typing___Optional[resource_manage_sdk___model___topology___linkStyle_pb2___LinkStyle] = None,
        ) -> None: ...
    if sys.version_info >= (3,):
        @classmethod
