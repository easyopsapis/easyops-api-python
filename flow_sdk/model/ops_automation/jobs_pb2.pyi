...
import sys
from flow_sdk.model.ops_automation.bind_resource_pb2 import (
    BindResource as flow_sdk___model___ops_automation___bind_resource_pb2___BindResource,
)

from flow_sdk.model.ops_automation.mail_info_pb2 import (
    MailInfo as flow_sdk___model___ops_automation___mail_info_pb2___MailInfo,
)
...
class Jobs(google___protobuf___message___Message):
    ...
    @property
    def bindResource(self) -> flow_sdk___model___ops_automation___bind_resource_pb2___BindResource: ...

    @property
    def mail(self) -> flow_sdk___model___ops_automation___mail_info_pb2___MailInfo: ...
    ...
    def __init__(self,
        *,
        ...
        bindResource : typing___Optional[flow_sdk___model___ops_automation___bind_resource_pb2___BindResource] = None,
        desc : typing___Optional[typing___Text] = None,
        allowModify : typing___Optional[builtin___bool] = None,
        mail : typing___Optional[flow_sdk___model___ops_automation___mail_info_pb2___MailInfo] = None,
