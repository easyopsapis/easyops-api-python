...
class PubSubscriber(google___protobuf___message___Message):
    ...
    if sys.version_info >= (3,):
        def ClearField(self, field_name: typing_extensions___Literal[u"admin",u"callback",u"ensName",u"name",u"org",u"retry",u"subscribeInfo",u"version"]) -> None: ...
    else:
        def ClearField(self, field_name: typing_extensions___Literal[b"admin",b"callback",b"ensName",b"name",b"org",b"retry",b"subscribeInfo",b"version"]) -> None: ...
