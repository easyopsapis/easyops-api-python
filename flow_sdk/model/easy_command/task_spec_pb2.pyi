...
import sys
from flow_sdk.model.easy_command.action_pb2 import (
    Action as flow_sdk___model___easy_command___action_pb2___Action,
)

from flow_sdk.model.easy_command.target_pb2 import (
    Target as flow_sdk___model___easy_command___target_pb2___Target,
)
...
class TaskSpec(google___protobuf___message___Message):
    ...
    @property
    def actions(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[flow_sdk___model___easy_command___action_pb2___Action]: ...

    @property
    def targets(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[flow_sdk___model___easy_command___target_pb2___Target]: ...
    ...
    def __init__(self,
        *,
        ...
        actions : typing___Optional[typing___Iterable[flow_sdk___model___easy_command___action_pb2___Action]] = None,
        targets : typing___Optional[typing___Iterable[flow_sdk___model___easy_command___target_pb2___Target]] = None,
