...
from ops_automation_sdk.model.notify.subscribe_info_pb2 import (
    SubscribeInfo as ops_automation_sdk___model___notify___subscribe_info_pb2___SubscribeInfo,
)
...
class Subscriber(google___protobuf___message___Message):
    ...
    @property
    def subscribeInfo(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[ops_automation_sdk___model___notify___subscribe_info_pb2___SubscribeInfo]: ...
    ...
    def __init__(self,
        *,
        ...
        subscribeInfo : typing___Optional[typing___Iterable[ops_automation_sdk___model___notify___subscribe_info_pb2___SubscribeInfo]] = None,
        ) -> None: ...
    if sys.version_info >= (3,):
        @classmethod
