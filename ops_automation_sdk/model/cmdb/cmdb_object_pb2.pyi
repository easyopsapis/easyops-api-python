...
from ops_automation_sdk.model.cmdb.object_attr_pb2 import (
    ObjectAttr as ops_automation_sdk___model___cmdb___object_attr_pb2___ObjectAttr,
)

from ops_automation_sdk.model.cmdb.object_index_pb2 import (
    ObjectIndex as ops_automation_sdk___model___cmdb___object_index_pb2___ObjectIndex,
)

from ops_automation_sdk.model.cmdb.object_relation_group_pb2 import (
    ObjectRelationGroup as ops_automation_sdk___model___cmdb___object_relation_group_pb2___ObjectRelationGroup,
)

from ops_automation_sdk.model.cmdb.object_relation_pb2 import (
    ObjectRelation as ops_automation_sdk___model___cmdb___object_relation_pb2___ObjectRelation,
)

from ops_automation_sdk.model.cmdb.object_view_pb2 import (
    ObjectView as ops_automation_sdk___model___cmdb___object_view_pb2___ObjectView,
)
...
class CmdbObject(google___protobuf___message___Message):
    ...
    @property
    def attrList(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[ops_automation_sdk___model___cmdb___object_attr_pb2___ObjectAttr]: ...

    @property
    def relation_list(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[ops_automation_sdk___model___cmdb___object_relation_pb2___ObjectRelation]: ...

    @property
    def relation_groups(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[ops_automation_sdk___model___cmdb___object_relation_group_pb2___ObjectRelationGroup]: ...

    @property
    def indexList(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[ops_automation_sdk___model___cmdb___object_index_pb2___ObjectIndex]: ...

    @property
    def view(self) -> ops_automation_sdk___model___cmdb___object_view_pb2___ObjectView: ...

    def __init__(self,
        *,
        attrList : typing___Optional[typing___Iterable[ops_automation_sdk___model___cmdb___object_attr_pb2___ObjectAttr]] = None,
        relation_list : typing___Optional[typing___Iterable[ops_automation_sdk___model___cmdb___object_relation_pb2___ObjectRelation]] = None,
        relation_groups : typing___Optional[typing___Iterable[ops_automation_sdk___model___cmdb___object_relation_group_pb2___ObjectRelationGroup]] = None,
        indexList : typing___Optional[typing___Iterable[ops_automation_sdk___model___cmdb___object_index_pb2___ObjectIndex]] = None,
        name : typing___Optional[typing___Text] = None,
        objectId : typing___Optional[typing___Text] = None,
        memo : typing___Optional[typing___Text] = None,
        view : typing___Optional[ops_automation_sdk___model___cmdb___object_view_pb2___ObjectView] = None,
