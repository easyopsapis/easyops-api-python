...
from ops_automation_sdk.model.inspection.target_pb2 import (
    InspectionTarget as ops_automation_sdk___model___inspection___target_pb2___InspectionTarget,
)
...
class InspectionHistory(google___protobuf___message___Message):
    ...
    @property
    def targets(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[ops_automation_sdk___model___inspection___target_pb2___InspectionTarget]: ...
    ...
    def __init__(self,
        *,
        ...
        targets : typing___Optional[typing___Iterable[ops_automation_sdk___model___inspection___target_pb2___InspectionTarget]] = None,
        ) -> None: ...
    if sys.version_info >= (3,):
        @classmethod
