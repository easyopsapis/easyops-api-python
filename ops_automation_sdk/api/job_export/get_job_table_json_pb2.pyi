...
class GetJobTableJsonRequest(google___protobuf___message___Message):
    ...
    @classmethod
    def FromString(cls, s: bytes) -> GetJobTableJsonRequest: ...
...
class GetJobTableJsonResponseWrapper(google___protobuf___message___Message):
    code = ... # type: int
    ...
    @classmethod
    def FromString(cls, s: bytes) -> GetJobTableJsonResponseWrapper: ...
    def MergeFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    if sys.version_info >= (3,):
