...
from ops_automation_sdk.model.ops_automation import scheduler_pb2 as ops__automation__sdk_dot_model_dot_ops__automation_dot_scheduler__pb2
...
_LISTJOBSREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='category', full_name='jobs.ListJobsRequest.category', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='name', full_name='jobs.ListJobsRequest.name', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='keyword', full_name='jobs.ListJobsRequest.keyword', index=5,
...
_LISTJOBSRESPONSE_LIST.fields_by_name['scheduler'].message_type = ops__automation__sdk_dot_model_dot_ops__automation_dot_scheduler__pb2._SCHEDULER
...
ListJobsResponseWrapper = _reflection.GeneratedProtocolMessageType('ListJobsResponseWrapper', (_message.Message,), {
