...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  serialized_pb=_b('\n\x12\x64\x65ploy_batch.proto\x12\teasy_flow\x1a)model/easy_flow/deploy_batch_target.proto\"\xc3\x01\n\x0b\x44\x65ployBatch\x12\x0c\n\x04type\x18\x01 \x01(\t\x12\x10\n\x08\x62\x61tchNum\x18\x02 \x01(\x05\x12\x15\n\rbatchInterval\x18\x03 \x01(\x05\x12/\n\x07\x62\x61tches\x18\x04 \x03(\x0b\x32\x1e.easy_flow.DeployBatch.Batches\x12\x12\n\nfailedStop\x18\x05 \x01(\t\x1a\x38\n\x07\x42\x61tches\x12-\n\x07targets\x18\x01 \x03(\x0b\x32\x1c.easy_flow.DeployBatchTargetBEZCgo.easyops.local/contracts/protorepo-models/easyops/model/easy_flowb\x06proto3')
  ,
  dependencies=[model_dot_easy__flow_dot_deploy__batch__target__pb2.DESCRIPTOR,])
...
_DEPLOYBATCH_BATCHES.fields_by_name['targets'].message_type = model_dot_easy__flow_dot_deploy__batch__target__pb2._DEPLOYBATCHTARGET
...
DeployBatch = _reflection.GeneratedProtocolMessageType('DeployBatch', (_message.Message,), dict(
