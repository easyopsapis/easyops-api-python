...
from tool_sdk.model.topboard.issue_pb2 import (
    Issue as tool_sdk___model___topboard___issue_pb2___Issue,
)
...
class RequirementInstance(google___protobuf___message___Message):
    ...
    @property
    def ISSUE(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[tool_sdk___model___topboard___issue_pb2___Issue]: ...
    ...
    def __init__(self,
        *,
        ...
        ISSUE : typing___Optional[typing___Iterable[tool_sdk___model___topboard___issue_pb2___Issue]] = None,
        ) -> None: ...
    if sys.version_info >= (3,):
        @classmethod
