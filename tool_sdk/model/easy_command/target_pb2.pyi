...
from tool_sdk.model.easy_command.action_param_custom_pb2 import (
    ActionParamCustom as tool_sdk___model___easy_command___action_param_custom_pb2___ActionParamCustom,
)
...
class Target(google___protobuf___message___Message):
    ...
    @property
    def actionParams(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[tool_sdk___model___easy_command___action_param_custom_pb2___ActionParamCustom]: ...

    def __init__(self,
        *,
        targetId : typing___Optional[typing___Text] = None,
        targetName : typing___Optional[typing___Text] = None,
        actionParams : typing___Optional[typing___Iterable[tool_sdk___model___easy_command___action_param_custom_pb2___ActionParamCustom]] = None,
        ) -> None: ...
    if sys.version_info >= (3,):
        @classmethod
