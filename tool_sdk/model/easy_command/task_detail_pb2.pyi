...
from tool_sdk.model.easy_command.target_log_pb2 import (
    TargetLog as tool_sdk___model___easy_command___target_log_pb2___TargetLog,
)
...
class TaskDetail(google___protobuf___message___Message):
    ...
    @property
    def targetsLog(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[tool_sdk___model___easy_command___target_log_pb2___TargetLog]: ...
    ...
    def __init__(self,
        *,
        ...
        targetsLog : typing___Optional[typing___Iterable[tool_sdk___model___easy_command___target_log_pb2___TargetLog]] = None,
        ) -> None: ...
    if sys.version_info >= (3,):
        @classmethod
