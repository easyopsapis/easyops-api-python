...
_EXECUTETOOLREQUEST_LOG = _descriptor.Descriptor(
  name='Log',
  full_name='execute.ExecuteToolRequest.Log',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='enabled', full_name='execute.ExecuteToolRequest.Log.enabled', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='level', full_name='execute.ExecuteToolRequest.Log.level', index=1,
...
_EXECUTETOOLREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='inputs', full_name='execute.ExecuteToolRequest.inputs', index=0,
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='execUser', full_name='execute.ExecuteToolRequest.execUser', index=7,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='timeout', full_name='execute.ExecuteToolRequest.timeout', index=8,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='log', full_name='execute.ExecuteToolRequest.log', index=9,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='ansibleNodeExecUser', full_name='execute.ExecuteToolRequest.ansibleNodeExecUser', index=10,
  ...
  nested_types=[_EXECUTETOOLREQUEST_METADATA, _EXECUTETOOLREQUEST_LOG, ],
  enum_types=[
  ],
  serialized_options=None,
  is_extendable=False,
...
_EXECUTETOOLREQUEST_LOG.containing_type = _EXECUTETOOLREQUEST
_EXECUTETOOLREQUEST.fields_by_name['inputs'].message_type = google_dot_protobuf_dot_struct__pb2._STRUCT
_EXECUTETOOLREQUEST.fields_by_name['callback'].message_type = tool__sdk_dot_model_dot_tool_dot_callback__pb2._CALLBACK
_EXECUTETOOLREQUEST.fields_by_name['metadata'].message_type = _EXECUTETOOLREQUEST_METADATA
_EXECUTETOOLREQUEST.fields_by_name['log'].message_type = _EXECUTETOOLREQUEST_LOG
...
ExecuteToolRequest = _reflection.GeneratedProtocolMessageType('ExecuteToolRequest', (_message.Message,), {
  ...
  'Log' : _reflection.GeneratedProtocolMessageType('Log', (_message.Message,), {
    'DESCRIPTOR' : _EXECUTETOOLREQUEST_LOG,
    '__module__' : 'execute_tool_pb2'
    # @@protoc_insertion_point(class_scope:execute.ExecuteToolRequest.Log)
    })
  ,
...
_sym_db.RegisterMessage(ExecuteToolRequest.Log)

ExecuteToolResponse = _reflection.GeneratedProtocolMessageType('ExecuteToolResponse', (_message.Message,), {
...
ExecuteToolResponseWrapper = _reflection.GeneratedProtocolMessageType('ExecuteToolResponseWrapper', (_message.Message,), {
