...
from easy_command_sdk.model.msgsender import send_message_request_data_pb2 as easy__command__sdk_dot_model_dot_msgsender_dot_send__message__request__data__pb2
...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  serialized_pb=_b('\n(send_message_with_appendix_request.proto\x12\tmsgsender\x1a@easy_command_sdk/model/msgsender/send_message_request_data.proto\"Q\n\x1eSendMessageWithAppendixRequest\x12/\n\x04\x64\x61ta\x18\x01 \x01(\x0b\x32!.msgsender.SendMessageRequestDataBEZCgo.easyops.local/contracts/protorepo-models/easyops/model/msgsenderb\x06proto3')
  ,
  dependencies=[easy__command__sdk_dot_model_dot_msgsender_dot_send__message__request__data__pb2.DESCRIPTOR,])
...
_SENDMESSAGEWITHAPPENDIXREQUEST.fields_by_name['data'].message_type = easy__command__sdk_dot_model_dot_msgsender_dot_send__message__request__data__pb2._SENDMESSAGEREQUESTDATA
