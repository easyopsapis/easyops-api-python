...
_TASKSPEC.fields_by_name['actions'].message_type = easy__command__sdk_dot_model_dot_easy__command_dot_action__pb2._ACTION
_TASKSPEC.fields_by_name['targets'].message_type = easy__command__sdk_dot_model_dot_easy__command_dot_target__pb2._TARGET
_TASKSPEC.fields_by_name['callback'].message_type = easy__command__sdk_dot_model_dot_easy__command_dot_task__callback__pb2._TASKCALLBACK
