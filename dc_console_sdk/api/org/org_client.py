...
import dc_console_sdk.utils.http_util
...
class OrgClient(object):
    ...
    def org_register(self, request, org, user, timeout=10):
        ...
        if self._service_name != "":
            ...
            route_name = "easyops.api.dc_console.org.OrgRegister"
        uri = "/api/v1/org/register"
        
        requestParam = request
        
        rsp_obj = dc_console_sdk.utils.http_util.do_api_request(
            method="POST",
            src_name="logic.dc_console_sdk",
            dst_name=route_name,
            server_ip=server_ip,
