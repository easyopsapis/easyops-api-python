...
_GETPLUGINVERSIONV1RESPONSE.fields_by_name['agentPlugin'].message_type = model_dot_agent__admin_dot_plugin__pb2._PLUGIN
_GETPLUGINVERSIONV1RESPONSE.fields_by_name['baseVersion'].message_type = model_dot_agent__admin_dot_plugin__version__pb2._PLUGINVERSION
...
GetPluginVersionV1Request = _reflection.GeneratedProtocolMessageType('GetPluginVersionV1Request', (_message.Message,), dict(
...
GetPluginVersionV1Response = _reflection.GeneratedProtocolMessageType('GetPluginVersionV1Response', (_message.Message,), dict(
...
GetPluginVersionV1ResponseWrapper = _reflection.GeneratedProtocolMessageType('GetPluginVersionV1ResponseWrapper', (_message.Message,), dict(
