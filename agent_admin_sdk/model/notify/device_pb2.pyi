...
class Device(google___protobuf___message___Message):
    ...
    if sys.version_info >= (3,):
        def ClearField(self, field_name: typing_extensions___Literal[u"instanceId",u"ip",u"targetId",u"targetName"]) -> None: ...
    else:
        def ClearField(self, field_name: typing_extensions___Literal[b"instanceId",b"ip",b"targetId",b"targetName"]) -> None: ...
