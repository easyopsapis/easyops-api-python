...
class Product(google___protobuf___message___Message):
    ...
    @property
    def sprints(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[agent_admin_sdk___model___topboard___sprint_pb2___Sprint]: ...

    def __init__(self,
        *,
        sprints : typing___Optional[typing___Iterable[agent_admin_sdk___model___topboard___sprint_pb2___Sprint]] = None,
