...
class Metadata(google___protobuf___message___Message):
    ...
    def HasField(self, field_name: typing_extensions___Literal[u"annotations",b"annotations",u"labels",b"labels"]) -> builtin___bool: ...
    def ClearField(self, field_name: typing_extensions___Literal[u"annotations",b"annotations",u"creationTimestamp",b"creationTimestamp",u"labels",b"labels",u"name",b"name",u"namespace",b"namespace"]) -> None: ...
