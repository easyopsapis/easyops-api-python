...
import sys
from agent_admin_sdk.model.console.cmdb_query_strategy_pb2 import (
    CmdbQueryStrategy as agent_admin_sdk___model___console___cmdb_query_strategy_pb2___CmdbQueryStrategy,
)

from agent_admin_sdk.model.resource_manage.filter_condition_group_pb2 import (
    FilterConditionGroup as agent_admin_sdk___model___resource_manage___filter_condition_group_pb2___FilterConditionGroup,
)
...
class FilterStrategy(google___protobuf___message___Message):
    ...
    @property
    def query(self) -> agent_admin_sdk___model___console___cmdb_query_strategy_pb2___CmdbQueryStrategy: ...

    @property
    def filter(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[agent_admin_sdk___model___resource_manage___filter_condition_group_pb2___FilterConditionGroup]: ...
    ...
    def __init__(self,
        *,
        ...
        query : typing___Optional[agent_admin_sdk___model___console___cmdb_query_strategy_pb2___CmdbQueryStrategy] = None,
        filter : typing___Optional[typing___Iterable[agent_admin_sdk___model___resource_manage___filter_condition_group_pb2___FilterConditionGroup]] = None,
