...
_CMDBOBJECT.fields_by_name['attrList'].message_type = cmdb__sdk_dot_model_dot_cmdb_dot_object__attr__pb2._OBJECTATTR
_CMDBOBJECT.fields_by_name['relation_list'].message_type = cmdb__sdk_dot_model_dot_cmdb_dot_object__relation__pb2._OBJECTRELATION
_CMDBOBJECT.fields_by_name['relation_groups'].message_type = cmdb__sdk_dot_model_dot_cmdb_dot_object__relation__group__pb2._OBJECTRELATIONGROUP
_CMDBOBJECT.fields_by_name['indexList'].message_type = cmdb__sdk_dot_model_dot_cmdb_dot_object__index__pb2._OBJECTINDEX
_CMDBOBJECT.fields_by_name['view'].message_type = cmdb__sdk_dot_model_dot_cmdb_dot_object__view__pb2._OBJECTVIEW
