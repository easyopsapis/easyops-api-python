...
class ListRequest(google___protobuf___message___Message):
    ...
    def ClearField(self, field_name: typing_extensions___Literal[u"ignoreAttrPermission",b"ignoreAttrPermission",u"page",b"page",u"page_size",b"page_size"]) -> None: ...
...
class ListResponse(google___protobuf___message___Message):
    ...
    @property
    def list(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[cmdb_sdk___model___cmdb___cmdb_object_pb2___CmdbObject]: ...
    ...
    def __init__(self,
        *,
        ...
        list : typing___Optional[typing___Iterable[cmdb_sdk___model___cmdb___cmdb_object_pb2___CmdbObject]] = None,
        ) -> None: ...
    if sys.version_info >= (3,):
        @classmethod
