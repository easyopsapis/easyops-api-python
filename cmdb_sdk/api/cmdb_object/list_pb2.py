...
_LISTREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='ignoreAttrPermission', full_name='cmdb_object.ListRequest.ignoreAttrPermission', index=2,
...
_LISTRESPONSE.fields_by_name['list'].message_type = cmdb__sdk_dot_model_dot_cmdb_dot_cmdb__object__pb2._CMDBOBJECT
