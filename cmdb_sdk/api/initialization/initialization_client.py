...
class InitializationClient(object):
    ...
    def init_database(self, request, org, user, timeout=10):
        ...
        if self._service_name != "":
            ...
            route_name = "easyops.api.cmdb.initialization.InitDatabase"
    ...
    def init_objects(self, request, org, user, timeout=10):
        ...
        if self._service_name != "":
            ...
            route_name = "easyops.api.cmdb.initialization.InitObjects"
    ...
    def init_relations(self, request, org, user, timeout=10):
        ...
        if self._service_name != "":
            ...
            route_name = "easyops.api.cmdb.initialization.InitRelations"
