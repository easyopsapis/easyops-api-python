...
_TRAVERSEGRAPHREQUEST.fields_by_name['child'].message_type = cmdb__sdk_dot_model_dot_cmdb_dot_traverse__child__node__pb2._TRAVERSECHILDNODE
...
TraverseGraphRequest = _reflection.GeneratedProtocolMessageType('TraverseGraphRequest', (_message.Message,), {
...
TraverseGraphResponse = _reflection.GeneratedProtocolMessageType('TraverseGraphResponse', (_message.Message,), {
...
TraverseGraphResponseWrapper = _reflection.GeneratedProtocolMessageType('TraverseGraphResponseWrapper', (_message.Message,), {
