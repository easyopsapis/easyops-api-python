...
_TRAVERSEGRAPHCOUNTREQUEST.fields_by_name['child'].message_type = model_dot_cmdb_dot_traverse__child__node__pb2._TRAVERSECHILDNODE
...
TraverseGraphCountRequest = _reflection.GeneratedProtocolMessageType('TraverseGraphCountRequest', (_message.Message,), dict(
...
TraverseGraphCountResponse = _reflection.GeneratedProtocolMessageType('TraverseGraphCountResponse', (_message.Message,), dict(
...
TraverseGraphCountResponseWrapper = _reflection.GeneratedProtocolMessageType('TraverseGraphCountResponseWrapper', (_message.Message,), dict(
