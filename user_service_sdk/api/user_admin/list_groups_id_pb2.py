...
ListGroupsIdRequest = _reflection.GeneratedProtocolMessageType('ListGroupsIdRequest', (_message.Message,), {
  'DESCRIPTOR' : _LISTGROUPSIDREQUEST,
  '__module__' : 'list_groups_id_pb2'
  # @@protoc_insertion_point(class_scope:user_admin.ListGroupsIdRequest)
  })
_sym_db.RegisterMessage(ListGroupsIdRequest)

ListGroupsIdResponseWrapper = _reflection.GeneratedProtocolMessageType('ListGroupsIdResponseWrapper', (_message.Message,), {
