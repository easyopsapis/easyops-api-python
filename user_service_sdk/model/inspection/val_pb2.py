...
_INSPECTIONVAL.fields_by_name['conditions'].message_type = model_dot_inspection_dot_condition__pb2._INSPECTIONCONDITION
DESCRIPTOR.message_types_by_name['InspectionVal'] = _INSPECTIONVAL
_sym_db.RegisterFileDescriptor(DESCRIPTOR)

InspectionVal = _reflection.GeneratedProtocolMessageType('InspectionVal', (_message.Message,), dict(
