...
from user_service_sdk.model.monitor_config import app_health_config_metrics_pb2 as user__service__sdk_dot_model_dot_monitor__config_dot_app__health__config__metrics__pb2
...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  serialized_pb=_b('\n\x1d\x61pp_health_config_layer.proto\x12\x0emonitor_config\x1a\x45user_service_sdk/model/monitor_config/app_health_config_metrics.proto\"y\n\x14\x41ppHealthConfigLayer\x12\n\n\x02id\x18\x01 \x01(\t\x12\x0c\n\x04name\x18\x02 \x01(\t\x12\x0e\n\x06weight\x18\x03 \x01(\x05\x12\x37\n\x07metrics\x18\x04 \x03(\x0b\x32&.monitor_config.AppHealthConfigMetricsBJZHgo.easyops.local/contracts/protorepo-models/easyops/model/monitor_configb\x06proto3')
  ,
  dependencies=[user__service__sdk_dot_model_dot_monitor__config_dot_app__health__config__metrics__pb2.DESCRIPTOR,])
...
_APPHEALTHCONFIGLAYER.fields_by_name['metrics'].message_type = user__service__sdk_dot_model_dot_monitor__config_dot_app__health__config__metrics__pb2._APPHEALTHCONFIGMETRICS
