...
from user_service_sdk.model.pipeline.build_status_pb2 import (
    BuildStatus as user_service_sdk___model___pipeline___build_status_pb2___BuildStatus,
)

from user_service_sdk.model.pipeline.git_meta_pb2 import (
    GitMeta as user_service_sdk___model___pipeline___git_meta_pb2___GitMeta,
)
...
class Build(google___protobuf___message___Message):
    ...
    @property
    def git_meta(self) -> user_service_sdk___model___pipeline___git_meta_pb2___GitMeta: ...

    @property
    def artifact(self) -> Build.Artifact: ...

    @property
    def status(self) -> user_service_sdk___model___pipeline___build_status_pb2___BuildStatus: ...

    def __init__(self,
        *,
        id : typing___Optional[typing___Text] = None,
        git_meta : typing___Optional[user_service_sdk___model___pipeline___git_meta_pb2___GitMeta] = None,
        ...
        status : typing___Optional[user_service_sdk___model___pipeline___build_status_pb2___BuildStatus] = None,
