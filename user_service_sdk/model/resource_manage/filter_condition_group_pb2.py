...
from user_service_sdk.model.resource_manage import filter_condition_pb2 as user__service__sdk_dot_model_dot_resource__manage_dot_filter__condition__pb2
...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  serialized_pb=_b('\n\x1c\x66ilter_condition_group.proto\x12\x0fresource_manage\x1a=user_service_sdk/model/resource_manage/filter_condition.proto\"]\n\x14\x46ilterConditionGroup\x12\x0c\n\x04name\x18\x01 \x01(\t\x12\x37\n\rconditionList\x18\x02 \x03(\x0b\x32 .resource_manage.FilterConditionBKZIgo.easyops.local/contracts/protorepo-models/easyops/model/resource_manageb\x06proto3')
  ,
  dependencies=[user__service__sdk_dot_model_dot_resource__manage_dot_filter__condition__pb2.DESCRIPTOR,])
...
_FILTERCONDITIONGROUP.fields_by_name['conditionList'].message_type = user__service__sdk_dot_model_dot_resource__manage_dot_filter__condition__pb2._FILTERCONDITION
