...
from user_service_sdk.model.cmdb.import_status_pb2 import (
    ImportStatus as user_service_sdk___model___cmdb___import_status_pb2___ImportStatus,
)
...
class ImportResult(google___protobuf___message___Message):
    ...
    @property
    def info_result(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[user_service_sdk___model___cmdb___import_status_pb2___ImportStatus]: ...

    @property
    def relation_group_result(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[user_service_sdk___model___cmdb___import_status_pb2___ImportStatus]: ...

    @property
    def attr_list_result(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[user_service_sdk___model___cmdb___import_status_pb2___ImportStatus]: ...

    @property
    def relation_list_result(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[user_service_sdk___model___cmdb___import_status_pb2___ImportStatus]: ...
    ...
    def __init__(self,
        *,
        ...
        code : typing___Optional[builtin___int] = None,
        message : typing___Optional[typing___Text] = None,
        info_result : typing___Optional[typing___Iterable[user_service_sdk___model___cmdb___import_status_pb2___ImportStatus]] = None,
        relation_group_result : typing___Optional[typing___Iterable[user_service_sdk___model___cmdb___import_status_pb2___ImportStatus]] = None,
        attr_list_result : typing___Optional[typing___Iterable[user_service_sdk___model___cmdb___import_status_pb2___ImportStatus]] = None,
        relation_list_result : typing___Optional[typing___Iterable[user_service_sdk___model___cmdb___import_status_pb2___ImportStatus]] = None,
