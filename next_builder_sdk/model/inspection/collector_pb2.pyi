...
from next_builder_sdk.model.inspection.arg_pb2 import (
    InspectionArg as next_builder_sdk___model___inspection___arg_pb2___InspectionArg,
)
...
class InspectionCollector(google___protobuf___message___Message):
    ...
    @property
    def args(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[next_builder_sdk___model___inspection___arg_pb2___InspectionArg]: ...
    ...
    def __init__(self,
        *,
        ...
        args : typing___Optional[typing___Iterable[next_builder_sdk___model___inspection___arg_pb2___InspectionArg]] = None,
        ) -> None: ...
    if sys.version_info >= (3,):
        @classmethod
