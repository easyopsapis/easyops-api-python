...
from next_builder_sdk.model.container.container_state_pb2 import (
    ContainerState as next_builder_sdk___model___container___container_state_pb2___ContainerState,
)
...
class ContainerStatus(google___protobuf___message___Message):
    ...
    @property
    def state(self) -> next_builder_sdk___model___container___container_state_pb2___ContainerState: ...

    def __init__(self,
        *,
        name : typing___Optional[typing___Text] = None,
        restartCount : typing___Optional[builtin___int] = None,
        state : typing___Optional[next_builder_sdk___model___container___container_state_pb2___ContainerState] = None,
