...
from next_builder_sdk.model.flowable_service.bpmn_links_pb2 import (
    BPMNLinks as next_builder_sdk___model___flowable_service___bpmn_links_pb2___BPMNLinks,
)

from next_builder_sdk.model.flowable_service.process_variable_pb2 import (
    ProcessVariable as next_builder_sdk___model___flowable_service___process_variable_pb2___ProcessVariable,
)
...
class BPMNUserTask(google___protobuf___message___Message):
    ...
    class ProcessOp(google___protobuf___message___Message):
        ...
        @property
        def conditionExpression(self) -> next_builder_sdk___model___flowable_service___process_variable_pb2___ProcessVariable: ...

        def __init__(self,
            *,
            name : typing___Optional[typing___Text] = None,
            conditionExpression : typing___Optional[next_builder_sdk___model___flowable_service___process_variable_pb2___ProcessVariable] = None,
    ...
    @property
    def links(self) -> next_builder_sdk___model___flowable_service___bpmn_links_pb2___BPMNLinks: ...
    ...
    def __init__(self,
        *,
        ...
        name : typing___Optional[typing___Text] = None,
        links : typing___Optional[next_builder_sdk___model___flowable_service___bpmn_links_pb2___BPMNLinks] = None,
