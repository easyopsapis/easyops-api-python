...
import sys
from data_ops_analysis_sdk.model.flowable_service.bpmn_links_pb2 import (
    BPMNLinks as data_ops_analysis_sdk___model___flowable_service___bpmn_links_pb2___BPMNLinks,
)

from data_ops_analysis_sdk.model.flowable_service.process_variable_pb2 import (
    ProcessVariable as data_ops_analysis_sdk___model___flowable_service___process_variable_pb2___ProcessVariable,
)
...
class BPMNUserTask(google___protobuf___message___Message):
    ...
    class ProcessOp(google___protobuf___message___Message):
        ...
        @property
        def conditionExpression(self) -> data_ops_analysis_sdk___model___flowable_service___process_variable_pb2___ProcessVariable: ...

        def __init__(self,
            *,
            name : typing___Optional[typing___Text] = None,
            conditionExpression : typing___Optional[data_ops_analysis_sdk___model___flowable_service___process_variable_pb2___ProcessVariable] = None,
    ...
    @property
    def links(self) -> data_ops_analysis_sdk___model___flowable_service___bpmn_links_pb2___BPMNLinks: ...
    ...
    def __init__(self,
        *,
        ...
        name : typing___Optional[typing___Text] = None,
        links : typing___Optional[data_ops_analysis_sdk___model___flowable_service___bpmn_links_pb2___BPMNLinks] = None,
