...
class ListRequest(google___protobuf___message___Message):
    ...
    def ClearField(self, field_name: typing_extensions___Literal[u"namespaceId",b"namespaceId",u"storageClassId",b"storageClassId"]) -> None: ...
...
class ListResponse(google___protobuf___message___Message):
    ...
    @property
    def list(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[container_sdk___model___container___persistent_volume_claim_pb2___PersistentVolumeClaim]: ...
    ...
    def __init__(self,
        *,
        ...
        list : typing___Optional[typing___Iterable[container_sdk___model___container___persistent_volume_claim_pb2___PersistentVolumeClaim]] = None,
        ) -> None: ...
    if sys.version_info >= (3,):
        @classmethod
