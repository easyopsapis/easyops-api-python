...
class ListEventRequest(google___protobuf___message___Message):
    ...
    fieldSelector = ... # type: typing___Text
    ...
    def __init__(self,
        *,
        ...
        fieldSelector : typing___Optional[typing___Text] = None,
    ...
    def ClearField(self, field_name: typing_extensions___Literal[u"clusterId",b"clusterId",u"fieldSelector",b"fieldSelector",u"labelSelector",b"labelSelector",u"namespace",b"namespace"]) -> None: ...
