...
class UpdateRequest(google___protobuf___message___Message):
    ...
    def HasField(self, field_name: typing_extensions___Literal[u"hpa",b"hpa"]) -> builtin___bool: ...
    def ClearField(self, field_name: typing_extensions___Literal[u"hpa",b"hpa",u"instanceId",b"instanceId"]) -> None: ...
...
class UpdateResponseWrapper(google___protobuf___message___Message):
    ...
    @property
    def data(self) -> container_sdk___model___container___hpa_pb2___HorizontalPodAutoscaler: ...
    ...
    def __init__(self,
        *,
        ...
        data : typing___Optional[container_sdk___model___container___hpa_pb2___HorizontalPodAutoscaler] = None,
        ) -> None: ...
    if sys.version_info >= (3,):
        @classmethod
