...
class GetResponseWrapper(google___protobuf___message___Message):
    ...
    @property
    def data(self) -> container_sdk___model___container___cluster_pb2___Cluster: ...
    ...
    def __init__(self,
        *,
        ...
        data : typing___Optional[container_sdk___model___container___cluster_pb2___Cluster] = None,
        ) -> None: ...
    if sys.version_info >= (3,):
        @classmethod
