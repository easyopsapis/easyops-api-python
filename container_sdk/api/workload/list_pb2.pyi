...
class ListRequest(google___protobuf___message___Message):
    ...
    serviceId = ... # type: typing___Text
    namespaceId = ... # type: typing___Text

    def __init__(self,
        *,
        rgId : typing___Optional[typing___Text] = None,
        serviceId : typing___Optional[typing___Text] = None,
    ...
    def ClearField(self, field_name: typing_extensions___Literal[u"namespaceId",b"namespaceId",u"rgId",b"rgId",u"serviceId",b"serviceId"]) -> None: ...
...
class ListResponse(google___protobuf___message___Message):
    ...
    @property
    def list(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[container_sdk___model___container___workload_pb2___Workload]: ...
    ...
    def __init__(self,
        *,
        ...
        list : typing___Optional[typing___Iterable[container_sdk___model___container___workload_pb2___Workload]] = None,
        ) -> None: ...
    if sys.version_info >= (3,):
        @classmethod
