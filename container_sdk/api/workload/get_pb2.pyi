...
class GetResponse(google___protobuf___message___Message):
    ...
    def MergeFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    def HasField(self, field_name: typing_extensions___Literal[u"hpa",b"hpa",u"resourceGroup",b"resourceGroup",u"workload",b"workload"]) -> builtin___bool: ...
    def ClearField(self, field_name: typing_extensions___Literal[u"hpa",b"hpa",u"resourceGroup",b"resourceGroup",u"workload",b"workload"]) -> None: ...
