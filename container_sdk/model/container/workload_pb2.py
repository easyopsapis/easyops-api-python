...
_WORKLOAD.fields_by_name['containers'].message_type = container__sdk_dot_model_dot_container_dot_container__pb2._CONTAINERCONFIG
_WORKLOAD.fields_by_name['volumes'].message_type = container__sdk_dot_model_dot_container_dot_volume__pb2._VOLUME
...
_WORKLOAD.fields_by_name['deploymentStrategy'].message_type = container__sdk_dot_model_dot_container_dot_deployment__strategy__pb2._DEPLOYMENTSTRATEGY
_WORKLOAD.fields_by_name['imagePullSecrets'].message_type = container__sdk_dot_model_dot_container_dot_local__object__reference__pb2._LOCALOBJECTREFERENCE
_WORKLOAD.fields_by_name['deploymentStatus'].message_type = container__sdk_dot_model_dot_container_dot_deployment__status__pb2._DEPLOYMENTSTATUS
