...
_INGRESS.fields_by_name['backend'].message_type = container__sdk_dot_model_dot_container_dot_ingress__backend__pb2._INGRESSBACKEND
_INGRESS.fields_by_name['rules'].message_type = container__sdk_dot_model_dot_container_dot_ingress__rule__pb2._INGRESSRULE
_INGRESS.fields_by_name['tls'].message_type = container__sdk_dot_model_dot_container_dot_ingress__tls__pb2._INGRESSTLS
