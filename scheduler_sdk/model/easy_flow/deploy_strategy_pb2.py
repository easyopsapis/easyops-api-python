...
_DEPLOYSTRATEGY_PACKAGELIST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='cluster', full_name='easy_flow.DeployStrategy.PackageList.cluster', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='targetVersion', full_name='easy_flow.DeployStrategy.PackageList.targetVersion', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='preStop', full_name='easy_flow.DeployStrategy.PackageList.preStop', index=2,
      number=3, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='postRestart', full_name='easy_flow.DeployStrategy.PackageList.postRestart', index=3,
      number=4, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='autoStart', full_name='easy_flow.DeployStrategy.PackageList.autoStart', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='userCheck', full_name='easy_flow.DeployStrategy.PackageList.userCheck', index=5,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='fullUpdate', full_name='easy_flow.DeployStrategy.PackageList.fullUpdate', index=6,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='force', full_name='easy_flow.DeployStrategy.PackageList.force', index=7,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='forceInstall', full_name='easy_flow.DeployStrategy.PackageList.forceInstall', index=8,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='packageId', full_name='easy_flow.DeployStrategy.PackageList.packageId', index=9,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='name', full_name='easy_flow.DeployStrategy.PackageList.name', index=10,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='installPath', full_name='easy_flow.DeployStrategy.PackageList.installPath', index=11,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='type', full_name='easy_flow.DeployStrategy.PackageList.type', index=12,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='platform', full_name='easy_flow.DeployStrategy.PackageList.platform', index=13,
...
_DEPLOYSTRATEGY_BATCHSTRATEGY_MANUALBATCH_BATCHES.fields_by_name['targets'].message_type = model_dot_easy__flow_dot_deploy__batch__target__pb2._DEPLOYBATCHTARGET
...
_DEPLOYSTRATEGY_PACKAGELIST.fields_by_name['cluster'].message_type = model_dot_cmdb_dot_cluster__info__pb2._CLUSTERINFO
...
_DEPLOYSTRATEGY.fields_by_name['clusters'].message_type = model_dot_cmdb_dot_cluster__info__pb2._CLUSTERINFO
_DEPLOYSTRATEGY.fields_by_name['targetList'].message_type = model_dot_easy__flow_dot_target__info__pb2._TARGETINFO
...
DeployStrategy = _reflection.GeneratedProtocolMessageType('DeployStrategy', (_message.Message,), dict(
