...
from scheduler_sdk.model.next_builder.micro_app_project_pb2 import (
    MicroAppProject as scheduler_sdk___model___next_builder___micro_app_project_pb2___MicroAppProject,
)

from scheduler_sdk.model.next_builder.storyboard_brick_pb2 import (
    StoryboardBrick as scheduler_sdk___model___next_builder___storyboard_brick_pb2___StoryboardBrick,
)

from scheduler_sdk.model.next_builder.storyboard_route_pb2 import (
    StoryboardRoute as scheduler_sdk___model___next_builder___storyboard_route_pb2___StoryboardRoute,
)
...
class StoryboardNode(google___protobuf___message___Message):
    ...
    @property
    def brick(self) -> scheduler_sdk___model___next_builder___storyboard_brick_pb2___StoryboardBrick: ...

    @property
    def route(self) -> scheduler_sdk___model___next_builder___storyboard_route_pb2___StoryboardRoute: ...

    @property
    def project(self) -> scheduler_sdk___model___next_builder___micro_app_project_pb2___MicroAppProject: ...
    ...
    def __init__(self,
        *,
        ...
        brick : typing___Optional[scheduler_sdk___model___next_builder___storyboard_brick_pb2___StoryboardBrick] = None,
        route : typing___Optional[scheduler_sdk___model___next_builder___storyboard_route_pb2___StoryboardRoute] = None,
        project : typing___Optional[scheduler_sdk___model___next_builder___micro_app_project_pb2___MicroAppProject] = None,
