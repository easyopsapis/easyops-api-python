...
class GetTaskResponse(google___protobuf___message___Message):
    class CmdConfig(google___protobuf___message___Message):
        ...
        @classmethod
        def FromString(cls, s: bytes) -> GetTaskResponse.CmdConfig: ...
        def MergeFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
        def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
        if sys.version_info >= (3,):
    ...
    class Annotations(google___protobuf___message___Message):
        ...
        @classmethod
        def FromString(cls, s: bytes) -> GetTaskResponse.Annotations: ...
        def MergeFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
        def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
        if sys.version_info >= (3,):
    ...
    class Callback(google___protobuf___message___Message):
        ...
        @classmethod
        def FromString(cls, s: bytes) -> GetTaskResponse.Callback: ...
        def MergeFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
        def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
        if sys.version_info >= (3,):
    ...
    @property
    def cmd_config(self) -> GetTaskResponse.CmdConfig: ...

    @property
    def annotations(self) -> GetTaskResponse.Annotations: ...

    @property
    def callback(self) -> GetTaskResponse.Callback: ...
    ...
    def __init__(self,
        ...
        cmd_config : typing___Optional[GetTaskResponse.CmdConfig] = None,
        ...
        annotations : typing___Optional[GetTaskResponse.Annotations] = None,
        ...
        callback : typing___Optional[GetTaskResponse.Callback] = None,
        assignner : typing___Optional[typing___Text] = None,
        ) -> None: ...
    @classmethod
    def FromString(cls, s: bytes) -> GetTaskResponse: ...
    def MergeFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    if sys.version_info >= (3,):
...
class GetTaskResponseWrapper(google___protobuf___message___Message):
    ...
    @property
    def data(self) -> GetTaskResponse: ...

    def __init__(self,
        code : typing___Optional[int] = None,
        codeExplain : typing___Optional[typing___Text] = None,
        error : typing___Optional[typing___Text] = None,
        data : typing___Optional[GetTaskResponse] = None,
        ) -> None: ...
    @classmethod
