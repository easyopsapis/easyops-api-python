...
class CreateTaskResponse(google___protobuf___message___Message):
    ...
    class Data(google___protobuf___message___Message):
        ...
        if sys.version_info >= (3,):
            @classmethod
            def FromString(cls, s: builtin___bytes) -> CreateTaskResponse.Data: ...
        else:
            @classmethod
            def FromString(cls, s: typing___Union[builtin___bytes, builtin___buffer, builtin___unicode]) -> CreateTaskResponse.Data: ...
    ...
    @property
    def data(self) -> CreateTaskResponse.Data: ...

    def __init__(self,
        *,
        code : typing___Optional[builtin___int] = None,
        msg : typing___Optional[typing___Text] = None,
        data : typing___Optional[CreateTaskResponse.Data] = None,
        ) -> None: ...
    if sys.version_info >= (3,):
        @classmethod
