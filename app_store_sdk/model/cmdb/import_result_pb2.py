...
from app_store_sdk.model.cmdb import import_status_pb2 as app__store__sdk_dot_model_dot_cmdb_dot_import__status__pb2
...
_IMPORTRESULT.fields_by_name['info_result'].message_type = app__store__sdk_dot_model_dot_cmdb_dot_import__status__pb2._IMPORTSTATUS
_IMPORTRESULT.fields_by_name['relation_group_result'].message_type = app__store__sdk_dot_model_dot_cmdb_dot_import__status__pb2._IMPORTSTATUS
_IMPORTRESULT.fields_by_name['attr_list_result'].message_type = app__store__sdk_dot_model_dot_cmdb_dot_import__status__pb2._IMPORTSTATUS
_IMPORTRESULT.fields_by_name['relation_list_result'].message_type = app__store__sdk_dot_model_dot_cmdb_dot_import__status__pb2._IMPORTSTATUS
