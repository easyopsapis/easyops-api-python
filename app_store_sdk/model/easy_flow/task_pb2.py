...
_TASK_BATCHES.fields_by_name['targets'].message_type = app__store__sdk_dot_model_dot_easy__flow_dot_deploy__target__pb2._DEPLOYTARGET
_TASK_BATCHES.containing_type = _TASK
_TASK.fields_by_name['targetList'].message_type = app__store__sdk_dot_model_dot_easy__flow_dot_target__info__pb2._TARGETINFO
_TASK.fields_by_name['packageList'].message_type = app__store__sdk_dot_model_dot_easy__flow_dot_package__info__pb2._PACKAGEINFO
