...
import sys
from app_store_sdk.model.pipeline.build_status_pb2 import (
    BuildStatus as app_store_sdk___model___pipeline___build_status_pb2___BuildStatus,
)

from app_store_sdk.model.pipeline.git_meta_pb2 import (
    GitMeta as app_store_sdk___model___pipeline___git_meta_pb2___GitMeta,
)
...
class Build(google___protobuf___message___Message):
    ...
    @property
    def git_meta(self) -> app_store_sdk___model___pipeline___git_meta_pb2___GitMeta: ...

    @property
    def artifact(self) -> Build.Artifact: ...

    @property
    def status(self) -> app_store_sdk___model___pipeline___build_status_pb2___BuildStatus: ...

    def __init__(self,
        *,
        id : typing___Optional[typing___Text] = None,
        git_meta : typing___Optional[app_store_sdk___model___pipeline___git_meta_pb2___GitMeta] = None,
        ...
        status : typing___Optional[app_store_sdk___model___pipeline___build_status_pb2___BuildStatus] = None,
