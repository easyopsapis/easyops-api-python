...
_FLOW.fields_by_name['stepList'].message_type = model_dot_flow_dot_flow__step__pb2._FLOWSTEP
_FLOW.fields_by_name['tableDefs'].message_type = _FLOW_TABLEDEFS
_FLOW.fields_by_name['flowEnv'].message_type = google_dot_protobuf_dot_struct__pb2._STRUCT
_FLOW.fields_by_name['metadata'].message_type = _FLOW_METADATA
_FLOW.fields_by_name['flowInputs'].message_type = model_dot_tool_dot_input__param__pb2._INPUT_PARAM
