...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  serialized_pb=_b('\n\rcomment.proto\x12\x08topboard\x1a;resource_package_tools_sdk/model/topboard/issue_basic.proto\x1a\x30resource_package_tools_sdk/model/cmdb/user.proto\"\x9b\x01\n\x07\x43omment\x12\x0c\n\x04name\x18\x01 \x01(\t\x12\x12\n\ninstanceId\x18\x02 \x01(\t\x12#\n\x05issue\x18\x03 \x03(\x0b\x32\x14.topboard.IssueBasic\x12\r\n\x05\x63time\x18\x04 \x01(\t\x12\x0c\n\x04\x62ody\x18\x05 \x01(\t\x12\x10\n\x08parentId\x18\x06 \x01(\t\x12\x1a\n\x06\x61uthor\x18\x07 \x03(\x0b\x32\n.cmdb.UserBDZBgo.easyops.local/contracts/protorepo-models/easyops/model/topboardb\x06proto3')
  ,
  dependencies=[resource__package__tools__sdk_dot_model_dot_topboard_dot_issue__basic__pb2.DESCRIPTOR,resource__package__tools__sdk_dot_model_dot_cmdb_dot_user__pb2.DESCRIPTOR,])
...
_COMMENT.fields_by_name['issue'].message_type = resource__package__tools__sdk_dot_model_dot_topboard_dot_issue__basic__pb2._ISSUEBASIC
_COMMENT.fields_by_name['author'].message_type = resource__package__tools__sdk_dot_model_dot_cmdb_dot_user__pb2._USER
