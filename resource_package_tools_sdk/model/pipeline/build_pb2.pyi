...
from resource_package_tools_sdk.model.pipeline.build_status_pb2 import (
    BuildStatus as resource_package_tools_sdk___model___pipeline___build_status_pb2___BuildStatus,
)

from resource_package_tools_sdk.model.pipeline.git_meta_pb2 import (
    GitMeta as resource_package_tools_sdk___model___pipeline___git_meta_pb2___GitMeta,
)
...
class Build(google___protobuf___message___Message):
    ...
    @property
    def git_meta(self) -> resource_package_tools_sdk___model___pipeline___git_meta_pb2___GitMeta: ...

    @property
    def artifact(self) -> Build.Artifact: ...

    @property
    def status(self) -> resource_package_tools_sdk___model___pipeline___build_status_pb2___BuildStatus: ...

    def __init__(self,
        *,
        id : typing___Optional[typing___Text] = None,
        git_meta : typing___Optional[resource_package_tools_sdk___model___pipeline___git_meta_pb2___GitMeta] = None,
        ...
        status : typing___Optional[resource_package_tools_sdk___model___pipeline___build_status_pb2___BuildStatus] = None,
