...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  serialized_pb=_b('\n\x1c\x62pmn_exclusive_gateway.proto\x12\x10\x66lowable_service\x1a\x42resource_package_tools_sdk/model/flowable_service/bpmn_links.proto\"N\n\x14\x42PMNExclusiveGateway\x12\n\n\x02id\x18\x01 \x01(\t\x12*\n\x05links\x18\x02 \x01(\x0b\x32\x1b.flowable_service.BPMNLinksBLZJgo.easyops.local/contracts/protorepo-models/easyops/model/flowable_serviceb\x06proto3')
  ,
  dependencies=[resource__package__tools__sdk_dot_model_dot_flowable__service_dot_bpmn__links__pb2.DESCRIPTOR,])
...
_BPMNEXCLUSIVEGATEWAY.fields_by_name['links'].message_type = resource__package__tools__sdk_dot_model_dot_flowable__service_dot_bpmn__links__pb2._BPMNLINKS
