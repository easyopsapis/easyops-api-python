...
from staff_manage_sdk.model.container.metric_target_pb2 import (
    MetricTarget as staff_manage_sdk___model___container___metric_target_pb2___MetricTarget,
)
...
class ResourceMetricSource(google___protobuf___message___Message):
    ...
    @property
    def target(self) -> staff_manage_sdk___model___container___metric_target_pb2___MetricTarget: ...

    def __init__(self,
        *,
        name : typing___Optional[typing___Text] = None,
        target : typing___Optional[staff_manage_sdk___model___container___metric_target_pb2___MetricTarget] = None,
        ) -> None: ...
    if sys.version_info >= (3,):
        @classmethod
