...
from staff_manage_sdk.model.topology import node_pb2 as staff__manage__sdk_dot_model_dot_topology_dot_node__pb2
from staff_manage_sdk.model.topology import link_pb2 as staff__manage__sdk_dot_model_dot_topology_dot_link__pb2
from staff_manage_sdk.model.topology import area_pb2 as staff__manage__sdk_dot_model_dot_topology_dot_area__pb2
from staff_manage_sdk.model.topology import note_pb2 as staff__manage__sdk_dot_model_dot_topology_dot_note__pb2
...
_VIEW_DIFF.fields_by_name['addNodes'].message_type = staff__manage__sdk_dot_model_dot_topology_dot_node__pb2._NODE
_VIEW_DIFF.fields_by_name['removeNodes'].message_type = staff__manage__sdk_dot_model_dot_topology_dot_node__pb2._NODE
_VIEW_DIFF.fields_by_name['addLinks'].message_type = staff__manage__sdk_dot_model_dot_topology_dot_link__pb2._LINK
_VIEW_DIFF.fields_by_name['removeLinks'].message_type = staff__manage__sdk_dot_model_dot_topology_dot_link__pb2._LINK
_VIEW_DIFF.containing_type = _VIEW
_VIEW.fields_by_name['rootNode'].message_type = staff__manage__sdk_dot_model_dot_topology_dot_node__pb2._NODE
_VIEW.fields_by_name['nodes'].message_type = staff__manage__sdk_dot_model_dot_topology_dot_node__pb2._NODE
_VIEW.fields_by_name['links'].message_type = staff__manage__sdk_dot_model_dot_topology_dot_link__pb2._LINK
_VIEW.fields_by_name['areas'].message_type = staff__manage__sdk_dot_model_dot_topology_dot_area__pb2._AREA
_VIEW.fields_by_name['notes'].message_type = staff__manage__sdk_dot_model_dot_topology_dot_note__pb2._NOTE
