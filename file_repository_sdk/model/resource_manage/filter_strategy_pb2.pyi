...
import sys
from file_repository_sdk.model.console.cmdb_query_strategy_pb2 import (
    CmdbQueryStrategy as file_repository_sdk___model___console___cmdb_query_strategy_pb2___CmdbQueryStrategy,
)

from file_repository_sdk.model.resource_manage.filter_condition_group_pb2 import (
    FilterConditionGroup as file_repository_sdk___model___resource_manage___filter_condition_group_pb2___FilterConditionGroup,
)
...
class FilterStrategy(google___protobuf___message___Message):
    ...
    @property
    def query(self) -> file_repository_sdk___model___console___cmdb_query_strategy_pb2___CmdbQueryStrategy: ...

    @property
    def filter(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[file_repository_sdk___model___resource_manage___filter_condition_group_pb2___FilterConditionGroup]: ...
    ...
    def __init__(self,
        *,
        ...
        query : typing___Optional[file_repository_sdk___model___console___cmdb_query_strategy_pb2___CmdbQueryStrategy] = None,
        filter : typing___Optional[typing___Iterable[file_repository_sdk___model___resource_manage___filter_condition_group_pb2___FilterConditionGroup]] = None,
