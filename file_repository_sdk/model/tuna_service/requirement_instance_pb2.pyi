...
import sys
from file_repository_sdk.model.topboard.issue_pb2 import (
    Issue as file_repository_sdk___model___topboard___issue_pb2___Issue,
)
...
class RequirementInstance(google___protobuf___message___Message):
    ...
    @property
    def ISSUE(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[file_repository_sdk___model___topboard___issue_pb2___Issue]: ...
    ...
    def __init__(self,
        *,
        ...
        ISSUE : typing___Optional[typing___Iterable[file_repository_sdk___model___topboard___issue_pb2___Issue]] = None,
        ) -> None: ...
    if sys.version_info >= (3,):
        @classmethod
