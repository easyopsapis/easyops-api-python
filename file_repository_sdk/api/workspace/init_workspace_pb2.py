...
_INITREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='XXX_RestFieldMask', full_name='workspace.InitRequest.XXX_RestFieldMask', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='packageId', full_name='workspace.InitRequest.packageId', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='versionId', full_name='workspace.InitRequest.versionId', index=2,
...
InitResponseWrapper = _reflection.GeneratedProtocolMessageType('InitResponseWrapper', (_message.Message,), {
