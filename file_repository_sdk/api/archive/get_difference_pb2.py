...
_GETDIFFERENCERESPONSEWRAPPER.fields_by_name['data'].message_type = model_dot_file__repository_dot_diff__pb2._DIFF
...
GetDifferenceRequest = _reflection.GeneratedProtocolMessageType('GetDifferenceRequest', (_message.Message,), dict(
...
GetDifferenceResponseWrapper = _reflection.GeneratedProtocolMessageType('GetDifferenceResponseWrapper', (_message.Message,), dict(
