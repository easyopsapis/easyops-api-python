...
_GETPACKAGEDIFFERENCERESPONSEWRAPPER.fields_by_name['data'].message_type = model_dot_file__repository_dot_diff__pb2._DIFF
...
GetPackageDifferenceRequest = _reflection.GeneratedProtocolMessageType('GetPackageDifferenceRequest', (_message.Message,), dict(
...
GetPackageDifferenceResponseWrapper = _reflection.GeneratedProtocolMessageType('GetPackageDifferenceResponseWrapper', (_message.Message,), dict(
