...
from architecture_view_sdk.model.topboard import product_pb2 as architecture__view__sdk_dot_model_dot_topboard_dot_product__pb2
from architecture_view_sdk.model.topboard import sprint_pb2 as architecture__view__sdk_dot_model_dot_topboard_dot_sprint__pb2
from architecture_view_sdk.model.cmdb import user_pb2 as architecture__view__sdk_dot_model_dot_cmdb_dot_user__pb2
from architecture_view_sdk.model.topboard import attachment_pb2 as architecture__view__sdk_dot_model_dot_topboard_dot_attachment__pb2
from architecture_view_sdk.model.topboard import comment_pb2 as architecture__view__sdk_dot_model_dot_topboard_dot_comment__pb2
...
_ISSUE.fields_by_name['product'].message_type = architecture__view__sdk_dot_model_dot_topboard_dot_product__pb2._PRODUCT
_ISSUE.fields_by_name['sprint'].message_type = architecture__view__sdk_dot_model_dot_topboard_dot_sprint__pb2._SPRINT
_ISSUE.fields_by_name['subscribers'].message_type = architecture__view__sdk_dot_model_dot_cmdb_dot_user__pb2._USER
_ISSUE.fields_by_name['assignee'].message_type = architecture__view__sdk_dot_model_dot_cmdb_dot_user__pb2._USER
_ISSUE.fields_by_name['reporter'].message_type = architecture__view__sdk_dot_model_dot_cmdb_dot_user__pb2._USER
_ISSUE.fields_by_name['attachments'].message_type = architecture__view__sdk_dot_model_dot_topboard_dot_attachment__pb2._ATTACHMENT
_ISSUE.fields_by_name['comments'].message_type = architecture__view__sdk_dot_model_dot_topboard_dot_comment__pb2._COMMENT
_ISSUE.fields_by_name['issueFrom'].message_type = _ISSUE_ISSUEFROM
_ISSUE.fields_by_name['tester'].message_type = architecture__view__sdk_dot_model_dot_cmdb_dot_user__pb2._USER
