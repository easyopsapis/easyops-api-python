...
import sys
from architecture_view_sdk.model.console.cmdb_query_strategy_pb2 import (
    CmdbQueryStrategy as architecture_view_sdk___model___console___cmdb_query_strategy_pb2___CmdbQueryStrategy,
)

from architecture_view_sdk.model.resource_manage.filter_condition_group_pb2 import (
    FilterConditionGroup as architecture_view_sdk___model___resource_manage___filter_condition_group_pb2___FilterConditionGroup,
)
...
class FilterStrategy(google___protobuf___message___Message):
    ...
    @property
    def query(self) -> architecture_view_sdk___model___console___cmdb_query_strategy_pb2___CmdbQueryStrategy: ...

    @property
    def filter(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[architecture_view_sdk___model___resource_manage___filter_condition_group_pb2___FilterConditionGroup]: ...
    ...
    def __init__(self,
        *,
        ...
        query : typing___Optional[architecture_view_sdk___model___console___cmdb_query_strategy_pb2___CmdbQueryStrategy] = None,
        filter : typing___Optional[typing___Iterable[architecture_view_sdk___model___resource_manage___filter_condition_group_pb2___FilterConditionGroup]] = None,
