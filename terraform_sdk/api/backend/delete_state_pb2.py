...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  serialized_pb=_b('\n\x12\x64\x65lete_state.proto\x12\x07\x62\x61\x63kend\x1a\x1bgoogle/protobuf/empty.proto\"=\n\x12\x44\x65leteStateRequest\x12\x0c\n\x04tfId\x18\x01 \x01(\t\x12\x0b\n\x03org\x18\x02 \x01(\t\x12\x0c\n\x04user\x18\x03 \x01(\t\"t\n\x1a\x44\x65leteStateResponseWrapper\x12\x0c\n\x04\x63ode\x18\x01 \x01(\x05\x12\x13\n\x0b\x63odeExplain\x18\x02 \x01(\t\x12\r\n\x05\x65rror\x18\x03 \x01(\t\x12$\n\x04\x64\x61ta\x18\x04 \x01(\x0b\x32\x16.google.protobuf.Emptyb\x06proto3')
  ,
...
_DELETESTATEREQUEST = _descriptor.Descriptor(
  ...
  full_name='backend.DeleteStateRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='tfId', full_name='backend.DeleteStateRequest.tfId', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='org', full_name='backend.DeleteStateRequest.org', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='user', full_name='backend.DeleteStateRequest.user', index=2,
...
_DELETESTATERESPONSEWRAPPER = _descriptor.Descriptor(
  ...
  full_name='backend.DeleteStateResponseWrapper',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='code', full_name='backend.DeleteStateResponseWrapper.code', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='codeExplain', full_name='backend.DeleteStateResponseWrapper.codeExplain', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='error', full_name='backend.DeleteStateResponseWrapper.error', index=2,
      number=3, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='data', full_name='backend.DeleteStateResponseWrapper.data', index=3,
...
DeleteStateRequest = _reflection.GeneratedProtocolMessageType('DeleteStateRequest', (_message.Message,), {
  ...
  # @@protoc_insertion_point(class_scope:backend.DeleteStateRequest)
  })
...
DeleteStateResponseWrapper = _reflection.GeneratedProtocolMessageType('DeleteStateResponseWrapper', (_message.Message,), {
  ...
  '__module__' : 'delete_state_pb2'
  # @@protoc_insertion_point(class_scope:backend.DeleteStateResponseWrapper)
  })
