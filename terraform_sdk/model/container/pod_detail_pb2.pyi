...
from terraform_sdk.model.container.pod_status_pb2 import (
    PodStatus as terraform_sdk___model___container___pod_status_pb2___PodStatus,
)
...
class PodDetail(google___protobuf___message___Message):
    ...
    @property
    def status(self) -> terraform_sdk___model___container___pod_status_pb2___PodStatus: ...

    def __init__(self,
        *,
        metadata : typing___Optional[terraform_sdk___model___container___metadata_pb2___Metadata] = None,
        status : typing___Optional[terraform_sdk___model___container___pod_status_pb2___PodStatus] = None,
        ) -> None: ...
    if sys.version_info >= (3,):
        @classmethod
