...
from terraform_sdk.model.container.service_port_pb2 import (
    ServicePort as terraform_sdk___model___container___service_port_pb2___ServicePort,
)
...
class ServiceSpec(google___protobuf___message___Message):
    ...
    @property
    def ports(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[terraform_sdk___model___container___service_port_pb2___ServicePort]: ...
    ...
    def __init__(self,
        *,
        ...
        ports : typing___Optional[typing___Iterable[terraform_sdk___model___container___service_port_pb2___ServicePort]] = None,
        ) -> None: ...
    if sys.version_info >= (3,):
        @classmethod
